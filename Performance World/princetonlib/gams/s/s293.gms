...
e1..  - (x1*x1 + 2*x2*x2 + 3*x3*x3 + 4*x4*x4 + 5*x5*x5 + 6*x6*x6 + 7*x7*x7 + 8*
     ...
     *x25 + 26*x26*x26 + 27*x27*x27 + 28*x28*x28 + 29*x29*x29 + 30*x30*x30 + 31
     *x31*x31 + 32*x32*x32 + 33*x33*x33 + 34*x34*x34 + 35*x35*x35 + 36*x36*x36
      + 37*x37*x37 + 38*x38*x38 + 39*x39*x39 + 40*x40*x40 + 41*x41*x41 + 42*x42
     *x42 + 43*x43*x43 + 44*x44*x44 + 45*x45*x45 + 46*x46*x46 + 47*x47*x47 + 48
     *x48*x48 + 49*x49*x49 + 50*x50*x50) + objvar =E= 0;
