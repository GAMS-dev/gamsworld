...
*   ```````````````````
*   Scheduling exams
*          INCOMP[See "Applications of optimization with Xpress-MP",
*        Section 14.4 Exam schedule)
*   - Reading indices from file + dynamic creation of variables. -
*
*          INCOMP[c) 2005 Artelys S.A. and Dash Associates
*
******************************************************************

* model "I-4 Scheduling exams        INCOMP[CP) - 2"
* uses "kalis"
...
* Solve the problem
Model I4_Scheduling_exams_CP_2 / all / ;

Solve I4_Scheduling_exams_CP_2 using MIP minimazing Obj ;
