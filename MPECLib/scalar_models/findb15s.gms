*  MPEC written by GAMS Convert at 11/14/01 10:42:25
*  
*  Equation counts
*     Total       E       G       L       N       X
*       203      77     113      13       0       0
...
e178..    x3 + x187 =G= -0.260297719227665;

e179..    x5 + x188 =G= 0.9973449467914;

e180..    x7 + x189 =G= 1.07446099003965;

e181..    x9 + x190 =G= 0.695560234932358;

e182..    x11 + x191 =G= 1.37636081989871;

e183..    x13 + x192 =G= 0.308227309718952;

e184..    x15 + x193 =G= -0.542837085000028;

e185..    x17 + x194 =G= -0.344876933903087;

e186..    x19 + x195 =G= 1.58683298221519;

e187..    x21 + x196 =G= 4.73261743946397;

e188..    x23 + x197 =G= 0.812300308806691;

e189..    x25 + x198 =G= -3.49602639209808;

e190..    x1 - x186 =L= -1.51794038524673;

e191..    x3 - x187 =L= -0.260297719227665;

e192..    x5 - x188 =L= 0.9973449467914;

e193..    x7 - x189 =L= 1.07446099003965;

e194..    x9 - x190 =L= 0.695560234932358;

e195..    x11 - x191 =L= 1.37636081989871;

e196..    x13 - x192 =L= 0.308227309718952;

e197..    x15 - x193 =L= -0.542837085000028;

e198..    x17 - x194 =L= -0.344876933903087;

e199..    x19 - x195 =L= 1.58683298221519;

e200..    x21 - x196 =L= 4.73261743946397;

e201..    x23 - x197 =L= 0.812300308806691;

e202..    x25 - x198 =L= -3.49602639209808;
