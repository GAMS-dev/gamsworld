*  MPEC written by GAMS Convert at 11/14/01 10:42:14
*  
*  Equation counts
*     Total       E       G       L       N       X
*       229      77     126      26       0       0
...
e177..    x1 + x186 =G= -1.51794038524673;

e178..    x2 + x187 =G= -0.889119052237198;

e179..    x3 + x188 =G= -0.260297719227665;

e180..    x4 + x189 =G= 0.368523613781867;

e181..    x5 + x190 =G= 0.9973449467914;

e182..    x6 + x191 =G= 1.45013447548017;

e183..    x7 + x192 =G= 1.07446099003965;

e184..    x8 + x193 =G= 0.710310158009282;

e185..    x9 + x194 =G= 0.695560234932358;

e186..    x10 + x195 =G= 1.02879730058471;

e187..    x11 + x196 =G= 1.37636081989871;

e188..    x12 + x197 =G= 0.913167080757714;

e189..    x13 + x198 =G= 0.308227309718952;

e190..    x14 + x199 =G= -0.205637629667187;

e191..    x15 + x200 =G= -0.542837085000028;

e192..    x16 + x201 =G= -0.617780403878892;

e193..    x17 + x202 =G= -0.344876933903087;

e194..    x18 + x203 =G= 0.361463977328047;

e195..    x19 + x204 =G= 1.58683298221519;

e196..    x20 + x205 =G= 3.24416108871169;

e197..    x21 + x206 =G= 4.73261743946397;

e198..    x22 + x207 =G= 2.96646365925907;

e199..    x23 + x208 =G= 0.812300308806691;

e200..    x24 + x209 =G= -1.3418630416457;

e201..    x25 + x210 =G= -3.49602639209808;

e202..    x26 + x211 =G= -5.65018974255047;

e203..    x1 - x186 =L= -1.51794038524673;

e204..    x2 - x187 =L= -0.889119052237198;

e205..    x3 - x188 =L= -0.260297719227665;

e206..    x4 - x189 =L= 0.368523613781867;

e207..    x5 - x190 =L= 0.9973449467914;

e208..    x6 - x191 =L= 1.45013447548017;

e209..    x7 - x192 =L= 1.07446099003965;

e210..    x8 - x193 =L= 0.710310158009282;

e211..    x9 - x194 =L= 0.695560234932358;

e212..    x10 - x195 =L= 1.02879730058471;

e213..    x11 - x196 =L= 1.37636081989871;

e214..    x12 - x197 =L= 0.913167080757714;

e215..    x13 - x198 =L= 0.308227309718952;

e216..    x14 - x199 =L= -0.205637629667187;

e217..    x15 - x200 =L= -0.542837085000028;

e218..    x16 - x201 =L= -0.617780403878892;

e219..    x17 - x202 =L= -0.344876933903087;

e220..    x18 - x203 =L= 0.361463977328047;

e221..    x19 - x204 =L= 1.58683298221519;

e222..    x20 - x205 =L= 3.24416108871169;

e223..    x21 - x206 =L= 4.73261743946397;

e224..    x22 - x207 =L= 2.96646365925907;

e225..    x23 - x208 =L= 0.812300308806691;

e226..    x24 - x209 =L= -1.3418630416457;

e227..    x25 - x210 =L= -3.49602639209808;

e228..    x26 - x211 =L= -5.65018974255047;
...
x1.l = -1.51794038524673; 
x2.l = -0.889119052237198; 
x3.l = -0.260297719227665; 
x4.l = 0.368523613781867; 
x5.l = 0.9973449467914; 
x6.l = 1.45013447548017; 
x7.l = 1.07446099003965; 
x8.l = 0.710310158009282; 
x9.l = 0.695560234932358; 
x10.l = 1.02879730058471; 
x11.l = 1.37636081989871; 
x12.l = 0.913167080757714; 
x13.l = 0.308227309718952; 
x14.l = -0.205637629667187; 
x15.l = -0.542837085000028; 
x16.l = -0.617780403878892; 
x17.l = -0.344876933903087; 
x18.l = 0.361463977328047; 
x19.l = 1.58683298221519; 
x20.l = 3.24416108871169; 
x21.l = 4.73261743946397; 
x22.l = 2.96646365925907; 
x23.l = 0.812300308806691; 
x24.l = -1.3418630416457; 
x25.l = -3.49602639209808; 
x26.l = -5.65018974255047; 
x27.l = 1; 
x28.l = 1; 
x29.l = 1; 
x30.l = 1; 
