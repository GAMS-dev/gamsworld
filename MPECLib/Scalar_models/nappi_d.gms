*  MPEC written by GAMS Convert at 01/04/02 11:31:21
*  
*  Equation counts
*     Total       E       G       L       N       X
*        98      60      30       8       0       0
...
e12..    x1 - x2 + 0.707106781186547*x9 - 0.707106781186547*x10 =E= 600;

e13..  - x4 - 0.707106781186547*x9 - 0.707106781186547*x10 =E= -600;

e14..  - x6 - 0.707106781186547*x9 =E= 0;

e15..    x3 + 0.707106781186547*x9 =E= -600;
...
e42..    x12 + x109 =G= 0.5174732726846;

e43..    x13 + x110 =G= -3.99487806835404;

e44..    x14 + x111 =G= -1.16402481386134;

e45..    x15 + x112 =G= -5.16065404541289;

e46..    x16 + x113 =G= -1.27862972708069;

e47..    x17 + x114 =G= -3.18446603788236;

e48..    x18 + x115 =G= -1.44489644745482;

e49..    x19 + x116 =G= -0.16626672037413;

e50..    x12 - x109 =L= 0.5174732726846;

e51..    x13 - x110 =L= -3.99487806835404;

e52..    x14 - x111 =L= -1.16402481386134;

e53..    x15 - x112 =L= -5.16065404541289;

e54..    x16 - x113 =L= -1.27862972708069;

e55..    x17 - x114 =L= -3.18446603788236;

e56..    x18 - x115 =L= -1.44489644745482;

e57..    x19 - x116 =L= -0.16626672037413;
...
x10.l = 1; 
x11.l = 1; 
x12.l = 0.5174732726846; 
x13.l = -3.99487806835404; 
x14.l = -1.16402481386134; 
x15.l = -5.16065404541289; 
x16.l = -1.27862972708069; 
x17.l = -3.18446603788236; 
x18.l = -1.44489644745482; 
x19.l = -0.16626672037413; 
x42.l = 10; 
x45.l = 10; 
x46.l = 10; 
x49.l = 10; 
