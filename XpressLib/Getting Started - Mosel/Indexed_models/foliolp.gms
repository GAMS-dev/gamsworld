...
* model "Portfolio_optimization_b with LP"
...
* Solve the problem
Model Portfolio_optimization_b / all / ;

Solve Portfolio_optimization_b using LP maximazing Return ;
