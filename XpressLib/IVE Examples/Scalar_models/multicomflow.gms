...
e3..    i8 + i9 + i10 + i11 =L= 75;

e4..    i12 + i13 + i14 =L= 100;

e5..    i15 + i16 + i17 =L= 70;

e6..    i1 + i6 + i7 + i9 + i11 + i12 + i16 =L= 120;

e7..    i2 + i3 + i4 + i5 + i8 + i10 + i12 + i16 =L= 300;

e8..    i3 + i5 + i6 + i10 + i11 + i14 + i16 + i17 =L= 80;

e9..    i3 + i4 + i7 + i10 + i11 + i14 + i15 =L= 70;

e10..    i2 + i5 + i7 + i9 + i10 + i13 + i17 =L= 300;

e11..    i3 + i4 + i7 + i8 + i9 + i12 + i13 + i15 =L= 200;

e12..  - i1 - i2 - i3 - i4 - i5 - i6 - i7 - i8 - i9 - i10 - i11 - i12 - i13
