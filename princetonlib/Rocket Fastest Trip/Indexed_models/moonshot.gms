...
acc_def(d,i)$((ord(i) ne card(i)))..   %n%*(v[d,i+1] - v[d,i]) =e= T*a[d,i];
...
model moonshot /all/;
solve moonshot using nlp minimize fuelcost;
...
Put x.l[d,i]:11:5 Put v.l[d,i]:11:5 Put a.l[d,i]:11:5 Put theta.l[d,i]:11:5
Put /;);
Put /;);