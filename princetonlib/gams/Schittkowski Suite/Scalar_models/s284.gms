...
e4..  - (50*sqr(x1) + 65*sqr(x4) + 35*sqr(x5) + 100*sqr(x6) + 35*sqr(x7) + 60*
...
e11..    20*x1 + 40*x2 + 400*x3 + 20*x4 + 80*x5 + 20*x6 + 40*x7 + 140*x8
       + 380*x9 + 280*x10 + 80*x11 + 40*x12 + 140*x13 + 40*x14 + 120*x15
       + objvar =E= 0;
