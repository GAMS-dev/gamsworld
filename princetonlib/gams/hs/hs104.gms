...
x1.lo = 0.1; x1.up = 10.1; 
x2.lo = 0.1; x2.up = 10.1; 
x3.lo = 0.1; x3.up = 10.1; 
x4.lo = 0.1; x4.up = 10.1; 
x5.lo = 0.1; x5.up = 10.1; 
x6.lo = 0.1; x6.up = 10.1; 
x7.lo = 0.1; x7.up = 10.1; 
x8.lo = 0.1; x8.up = 10.1; 
