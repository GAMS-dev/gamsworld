...
e1.. (-0.5*sqrt(x1)*x7/(sqr(x6)*x3)) - 0.7*POWER(x1,3)*x2*x6*sqrt(x7)/sqr(x3)
      - 0.2*exp(0.666666666666667*log(x6))*x3*sqr(sqr(x7))/(sqrt(x4)*x2)
      =G= -1;
...
e4.. (-0.2*sqrt(x5)*x2*exp(0.333333333333333*log(x7))/(sqr(x1)*x4)) - 0.3*sqrt(
     x1)*sqr(x2)*x3*exp(0.333333333333333*log(x4))*sqr(sqr(x7))/exp(
     0.666666666666667*log(x5)) - 0.4*x3*x5*exp(0.75*log(x7))/(POWER(x1,3)*sqr(
     x2)) - 0.5*sqrt(x7)*x4/sqr(x3) =G= -1;

e5.. 10*sqr(x4)*x1*exp(0.125*log(x7))/(POWER(x6,3)*x2) + 15*x3*x4/(sqr(x2)*x1*
     x5*sqrt(x7)) + 20*x2*x6/(sqr(x1)*x4*sqr(x5)) + 25*sqr(x1)*sqr(x2)*sqrt(x5)
     *x7/(sqr(x6)*x3) =G= 100;

e6.. 10*sqr(x4)*x1*exp(log(0.125*x7))/(POWER(x6,3)*x2) + 15*x3*x4/(sqr(x2)*x1*
     x5*sqrt(x7)) + 20*x2*x6/(sqr(x1)*x4*sqr(x5)) + 25*sqr(x1)*sqr(x2)*sqrt(x5)
     *x7/(sqr(x6)*x3) =L= 3000;

e7..  - (10*sqr(x4)*x1*exp(0.125*log(x7))/(POWER(x6,3)*x2) + 15*x3*x4/(sqr(x2)*
     x1*x5*sqrt(x7)) + 20*x2*x6/(sqr(x1)*x4*sqr(x5)) + 25*sqr(x1)*sqr(x2)*sqrt(
     x5)*x7/(sqr(x6)*x3)) + objvar =E= 0;
