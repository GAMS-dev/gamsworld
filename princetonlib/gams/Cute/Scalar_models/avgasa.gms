...
e11..  - (2*sqr(x1) + 2*sqr(x2) + 2.5*sqr(x3) + 1.5*sqr(x4) + 2.5*sqr(x5) + 2*
      sqr(x6) + 2.5*sqr(x7) + 2.5*sqr(x8) + (-x1*x2) - 2*x2*x3 - x3*x4 - x4*x5
       + 2*x5*x6 - x6*x7 - 2*x7*x8 - 2*x2 - x3 - 3*x4 - 2*x5 - 4*x6 - 3*x7 - 5*
      x8) + objvar =E= 0;
