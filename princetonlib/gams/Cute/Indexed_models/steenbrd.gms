...
Parameter cost(i) / i1   35.0 ,  i2  40.0 ,  i3   30.0 ,  i4  100.0 ,
                    i5   15.0 ,  i6  55.0 ,  i7  100.0 ,  i8   25.0 ,
                    i9   60.0 , i10  35.0 , i11   55.0 , i12   15.0 ,
                   i13   40.0 , i14  60.0 , i15   25.0 , i16   30.0 ,
                   i17   50.0 , i18  50.0 / ;
...
f=e=sum{i,((lt[i]*sum{j,d[j,i]} + lc[i]/cd[i]/cd[i]*power((sum{j,d[j,i]}),3)) +
           (lt[i]*sum{j,r[j,i]} + lc[i]/cr[i]/cr[i]*power((sum{j,r[j,i]}),3)) +
                   ...
                   la[i]*sqrt(cr[i]-cmr[i]+nonz))}/1000000;
...
Solve steenbrd using nlp minimazing f ;
f.l= f.l*1000000;
display f.l ;
