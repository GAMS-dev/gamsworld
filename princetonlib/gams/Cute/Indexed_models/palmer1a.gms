...
Def_obj..   palmer =e= sum{m,sqr(Y[m]-A0-A2*(sqr(X[m]))-A4*(power(X[m],4))-A6*
                                        (power(X[m],6))-(B/(C+(sqr(X[m])))))};
...
Solve palmer1a using nlp minimazing palmer ;

display A0.l , A2.l , A4.l , A6.l , B.l , C.l , palmer.l ;
