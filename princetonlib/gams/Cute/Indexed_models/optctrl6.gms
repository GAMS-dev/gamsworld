...
Variable x0, y0, x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, x6, y6,
         x7, y7, x8, y8, x9, y9, x10, y10, x11, y11, x12, y12,
         x13, y13, x14, y14, x15, y15, x16, y16, x17, y17, x18,
         y18, x19, y19, x20, y20, x21, y21, x22, y22, x23, y23,
         x24, y24, x25, y25, x26, y26, x27, y27, x28, y28, x29,
         y29, x30, y30, x31, y31, x32, y32, x33, y33, x34, y34,
         x35, y35, x36, y36, x37, y37, x38, y38, x39, y39, x40,
         y40, u0, u1, u2, u3, u4, u5, u6, u7, u8, u9, u10, u11,
         u12, u13, u14, u15, u16, u17, u18, u19, u20, u21, u22,
         u23, u24, u25, u26, u27, u28, u29, u30, u31, u32, u33,
         u34, u35, u36, u37, u38, u39, obj ;

Equation b0, c0, b1, c1, b2, c2, b3, c3, b4, c4, b5, c5, b6, c6, b7, c7, b8,
         c8, b9, c9, b10, c10, b11, c11, b12, c12, b13, c13, b14, c14, b15,
         c15, b16, c16, b17, c17, b18, c18, b19, c19, b20, c20, b21, c21, b22,
         c22, b23, c23, b24, c24, b25, c25, b26, c26, b27, c27, b28, c28, b29,
         c29, b30, c30, b31, c31, b32, c32, b33, c33, b34, c34, b35, c35, b36,
         c36, b37, c37, b38, c38, b39, c39, obj_bnd , def_obj ;
...
def_obj..
obj =e= 0.5*x0 * x0 + 0.5*x1 * x1 + 0.5*x2 * x2 + 0.5*x3 * x3 +
...
y37.l = -1.0 ; y38.l = -1.0 ; y39.l = -1.0 ;
 ...
 y0.lo =  0.0;  y0.up =  0.0;
y40.lo =  0.0; y40.up =  0.0;

Model optctrl6 /all/ ;

Solve optctrl6  using nlp minimazing obj;
