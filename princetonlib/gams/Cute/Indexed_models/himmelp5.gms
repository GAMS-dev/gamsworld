...
Parameter xinit[j]  / j1 68.8 , j2 31.2 /;
...
cons5.. 5    *    x['j1']  +100*x['j2'] - sqr(x['j2']) - 2775.0 =l= 0 ;
...
Def_obj..
  f =e= -b['i2']*x['j1']-b['i6']*x['j2']-b['i1']-
                      ( b['i3']* power(x['j1'],2)+
                       ...
                       b['i15']* power(x['j1'],2) +
                       b['i16']* power(x['j1'],3))*power(x['j2'],2) + (
                       b['i17']* power(x['j1'],3)+b['i19']*
                       x['j1'])* power(x['j2'],3) +
...
Solve himmelp5 using nlp minimazing f ;
