...
$offdigit ;
        ...
        parameter    lp3;    lp3 = 3 + (2);
        parameter     ie;     ie = 2 + (52);
...
Def_obj..  obj =e=
 ...
 x1.lo= 0.1;x2.lo = 0.1; x3.lo= 0.1; x5.lo= 0.1; x6.lo=0.0;
 x7.lo= 0.1;x9.lo = 0.1;x11.lo= 0.1;x12.lo= 0.0;x13.lo=0.1;
x15.lo= 0.0;x18.lo= 0.0;x21.lo= 0.0;x22.lo= 0.1;x24.lo=0.1;
x27.lo= 0.0;x30.lo= 0.0;x33.lo= 0.1;x35.lo= 0.1;x36.lo=0.0;
x39.lo= 0.0;x42.lo= 0.0;x44.lo= 0.1;x45.lo= 0.0;x46.lo=4.0;
x48.lo= 0.0;x51.lo= 0.0;x54.lo= 0.0;x55.lo= 4.0;x59.lo=4.0;
x60.lo= 4.0;

 x6.up = 0.0;x12.up = 0.0;x15.up = 0.0;x18.up = 0.0;x21.up = 0.0;
x27.up = 0.0;x30.up = 0.0;x36.up = 0.0;x39.up = 0.0;x42.up = 0.0;
x45.up = 0.0;x46.up = 5.0;x48.up = 0.0;x51.up = 0.0;x54.up = 0.0;
x55.up = 5.0;x59.up = 5.0;x60.up = 5.0;

Model gridnetg  /all/;

Solve gridnetg using nlp minimize obj;
