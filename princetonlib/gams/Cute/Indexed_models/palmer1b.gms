...
Parameter X(m) / m1 -1.788963 ,  m2 -1.745329 ,  m3 -1.658063 ,  m4 -1.570796 ,
                ...
                m29 0.523599  , m30 0.349066  , m31 0.174533  , m32 -1.8762289,
                m33 -1.8325957, m34 1.8762289 , m35 1.8325957 /   ;

Parameter Y(m) / m1 78.596218 ,  m2 65.77963  ,  m3 43.96947  ,  m4 27.038816 ,
                ...
                m29 52.3664   , m30 70.1630   , m31 83.4221   , m32 108.18086 ,
                m33 92.733676 , m34 108.18086 , m35 92.733676 /   ;

Variable A2, A4 , B, C, palmer ;

Equation Def_obj ;

Def_obj.. palmer =e= sum{m,sqr(Y[m]-(A2*(sqr(X[m]))+A4*(power(X[m],4))+B/
                                                           (C+(sqr(X[m])))))} ;
A2.l = 1.0;
A4.l = 1.0;
B.lo = 0; B.l = 1.0;
...
Solve palmer1b using nlp minimazing palmer ;
