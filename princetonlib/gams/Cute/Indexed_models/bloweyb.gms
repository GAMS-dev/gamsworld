...
v[i]$(ord(i) le 101)                     = 1.0                               ;
v[i]$((ord(i) ge 102)and(ord(i) le  401))=( 1-(ord(i)-1-%N%*A)*2/(%N%*(B-A)));
v[i]$((ord(i) ge 402)and(ord(i) le  601))=-1.0                               ;
v[i]$((ord(i) ge 602)and(ord(i) le  901))=(-1+(ord(i)-1-%N%*C)*2/(%N%*(D-C)));
v[i]$((ord(i) ge 902)and(ord(i) le 1000))= 1.0                               ;
...
Solve bloweyb using nlp minimize f;
