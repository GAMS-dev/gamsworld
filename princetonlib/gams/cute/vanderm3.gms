...
e1.. sqr((-51.49) + x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 + x10 + x11 + 
     ...
     x96 + x97 + x98 + x99 + x100) =E= 0;

e2.. sqr((-34.8349) + sqr(x1) + sqr(x2) + sqr(x3) + sqr(x4) + sqr(x5) + sqr(x6)
...
e3.. sqr((-26.502499) + POWER(x1,3) + POWER(x2,3) + POWER(x3,3) + POWER(x4,3)
     ...
     POWER(x97,3) + POWER(x98,3) + POWER(x99,3) + POWER(x100,3)) =E= 0;

e4.. sqr((-21.50333329) + POWER(x1,4) + POWER(x2,4) + POWER(x3,4) + POWER(x4,4)
     ...
     POWER(x97,4) + POWER(x98,4) + POWER(x99,4) + POWER(x100,4)) =E= 0;

e5.. sqr((-18.1708332499) + POWER(x1,5) + POWER(x2,5) + POWER(x3,5) + POWER(x4,
     5) + POWER(x5,5) + POWER(x6,5) + POWER(x7,5) + POWER(x8,5) + POWER(x9,5)
      + POWER(x10,5) + POWER(x11,5) + POWER(x12,5) + POWER(x13,5) + POWER(x14,5
     ) + POWER(x15,5) + POWER(x16,5) + POWER(x17,5) + POWER(x18,5) + POWER(x19,
     5) + POWER(x20,5) + POWER(x21,5) + POWER(x22,5) + POWER(x23,5) + POWER(x24
     ,5) + POWER(x25,5) + POWER(x26,5) + POWER(x27,5) + POWER(x28,5) + POWER(
     x29,5) + POWER(x30,5) + POWER(x31,5) + POWER(x32,5) + POWER(x33,5) + 
     POWER(x34,5) + POWER(x35,5) + POWER(x36,5) + POWER(x37,5) + POWER(x38,5)
      + POWER(x39,5) + POWER(x40,5) + POWER(x41,5) + POWER(x42,5) + POWER(x43,5
     ) + POWER(x44,5) + POWER(x45,5) + POWER(x46,5) + POWER(x47,5) + POWER(x48,
     5) + POWER(x49,5) + POWER(x50,5) + POWER(x51,5) + POWER(x52,5) + POWER(x53
     ,5) + POWER(x54,5) + POWER(x55,5) + POWER(x56,5) + POWER(x57,5) + POWER(
     x58,5) + POWER(x59,5) + POWER(x60,5) + POWER(x61,5) + POWER(x62,5) + 
     POWER(x63,5) + POWER(x64,5) + POWER(x65,5) + POWER(x66,5) + POWER(x67,5)
      + POWER(x68,5) + POWER(x69,5) + POWER(x70,5) + POWER(x71,5) + POWER(x72,5
     ) + POWER(x73,5) + POWER(x74,5) + POWER(x75,5) + POWER(x76,5) + POWER(x77,
     5) + POWER(x78,5) + POWER(x79,5) + POWER(x80,5) + POWER(x81,5) + POWER(x82
     ,5) + POWER(x83,5) + POWER(x84,5) + POWER(x85,5) + POWER(x86,5) + POWER(
     x87,5) + POWER(x88,5) + POWER(x89,5) + POWER(x90,5) + POWER(x91,5) + 
     POWER(x92,5) + POWER(x93,5) + POWER(x94,5) + POWER(x95,5) + POWER(x96,5)
      + POWER(x97,5) + POWER(x98,5) + POWER(x99,5) + POWER(x100,5)) =E= 0;

e6.. sqr((-15.790714119049) + POWER(x1,6) + POWER(x2,6) + POWER(x3,6) + POWER(
     x4,6) + POWER(x5,6) + POWER(x6,6) + POWER(x7,6) + POWER(x8,6) + POWER(x9,6
     ) + POWER(x10,6) + POWER(x11,6) + POWER(x12,6) + POWER(x13,6) + POWER(x14,
     6) + POWER(x15,6) + POWER(x16,6) + POWER(x17,6) + POWER(x18,6) + POWER(x19
     ,6) + POWER(x20,6) + POWER(x21,6) + POWER(x22,6) + POWER(x23,6) + POWER(
     x24,6) + POWER(x25,6) + POWER(x26,6) + POWER(x27,6) + POWER(x28,6) + 
     POWER(x29,6) + POWER(x30,6) + POWER(x31,6) + POWER(x32,6) + POWER(x33,6)
      + POWER(x34,6) + POWER(x35,6) + POWER(x36,6) + POWER(x37,6) + POWER(x38,6
     ) + POWER(x39,6) + POWER(x40,6) + POWER(x41,6) + POWER(x42,6) + POWER(x43,
     6) + POWER(x44,6) + POWER(x45,6) + POWER(x46,6) + POWER(x47,6) + POWER(x48
     ,6) + POWER(x49,6) + POWER(x50,6) + POWER(x51,6) + POWER(x52,6) + POWER(
     x53,6) + POWER(x54,6) + POWER(x55,6) + POWER(x56,6) + POWER(x57,6) + 
     POWER(x58,6) + POWER(x59,6) + POWER(x60,6) + POWER(x61,6) + POWER(x62,6)
      + POWER(x63,6) + POWER(x64,6) + POWER(x65,6) + POWER(x66,6) + POWER(x67,6
     ) + POWER(x68,6) + POWER(x69,6) + POWER(x70,6) + POWER(x71,6) + POWER(x72,
     6) + POWER(x73,6) + POWER(x74,6) + POWER(x75,6) + POWER(x76,6) + POWER(x77
     ,6) + POWER(x78,6) + POWER(x79,6) + POWER(x80,6) + POWER(x81,6) + POWER(
     x82,6) + POWER(x83,6) + POWER(x84,6) + POWER(x85,6) + POWER(x86,6) + 
     POWER(x87,6) + POWER(x88,6) + POWER(x89,6) + POWER(x90,6) + POWER(x91,6)
      + POWER(x92,6) + POWER(x93,6) + POWER(x94,6) + POWER(x95,6) + POWER(x96,6
     ) + POWER(x97,6) + POWER(x98,6) + POWER(x99,6) + POWER(x100,6)) =E= 0;

e7.. sqr((-14.005833041675) + POWER(x1,7) + POWER(x2,7) + POWER(x3,7) + POWER(
     ...
     ) + POWER(x97,7) + POWER(x98,7) + POWER(x99,7) + POWER(x100,7)) =E= 0;

e8.. sqr((-12.6177773111333) + POWER(x1,8) + POWER(x2,8) + POWER(x3,8) + POWER(
     ...
     ) + POWER(x97,8) + POWER(x98,8) + POWER(x99,8) + POWER(x100,8)) =E= 0;

e9.. sqr((-11.50749930005) + POWER(x1,9) + POWER(x2,9) + POWER(x3,9) + POWER(x4
     ...
     POWER(x92,9) + POWER(x93,9) + POWER(x94,9) + POWER(x95,9) + POWER(x96,9)
      + POWER(x97,9) + POWER(x98,9) + POWER(x99,9) + POWER(x100,9)) =E= 0;

e10.. sqr((-10.5992414243424) + POWER(x1,10) + POWER(x2,10) + POWER(x3,10) + 
      ...
      x94,10) + POWER(x95,10) + POWER(x96,10) + POWER(x97,10) + POWER(x98,10)
       + POWER(x99,10) + POWER(x100,10)) =E= 0;

e11.. sqr((-9.84249862518332) + POWER(x1,11) + POWER(x2,11) + POWER(x3,11) + 
      ...
      x94,11) + POWER(x95,11) + POWER(x96,11) + POWER(x97,11) + POWER(x98,11)
       + POWER(x99,11) + POWER(x100,11)) =E= 0;

e12.. sqr((-9.20230585928861) + POWER(x1,12) + POWER(x2,12) + POWER(x3,12) + 
      ...
      x94,12) + POWER(x95,12) + POWER(x96,12) + POWER(x97,12) + POWER(x98,12)
       + POWER(x99,12) + POWER(x100,12)) =E= 0;

e13.. sqr((-8.65368809336779) + POWER(x1,13) + POWER(x2,13) + POWER(x3,13) + 
      ...
      x94,13) + POWER(x95,13) + POWER(x96,13) + POWER(x97,13) + POWER(x98,13)
       + POWER(x99,13) + POWER(x100,13)) =E= 0;

e14.. sqr((-8.1783303007943) + POWER(x1,14) + POWER(x2,14) + POWER(x3,14) + 
      ...
      x94,14) + POWER(x95,14) + POWER(x96,14) + POWER(x97,14) + POWER(x98,14)
       + POWER(x99,14) + POWER(x100,14)) =E= 0;

e15.. sqr((-7.76249620952473) + POWER(x1,15) + POWER(x2,15) + POWER(x3,15) + 
      ...
      x94,15) + POWER(x95,15) + POWER(x96,15) + POWER(x97,15) + POWER(x98,15)
       + POWER(x99,15) + POWER(x100,15)) =E= 0;

e16.. sqr((-7.39568160957599) + POWER(x1,16) + POWER(x2,16) + POWER(x3,16) + 
      ...
      x94,16) + POWER(x95,16) + POWER(x96,16) + POWER(x97,16) + POWER(x98,16)
       + POWER(x99,16) + POWER(x100,16)) =E= 0;

e17.. sqr((-7.0697165580103) + POWER(x1,17) + POWER(x2,17) + POWER(x3,17) + 
      ...
      x94,17) + POWER(x95,17) + POWER(x96,17) + POWER(x97,17) + POWER(x98,17)
       + POWER(x99,17) + POWER(x100,17)) =E= 0;

e18.. sqr((-6.77815109813552) + POWER(x1,18) + POWER(x2,18) + POWER(x3,18) + 
      ...
      x94,18) + POWER(x95,18) + POWER(x96,18) + POWER(x97,18) + POWER(x98,18)
       + POWER(x99,18) + POWER(x100,18)) =E= 0;

e19.. sqr((-6.51582526294552) + POWER(x1,19) + POWER(x2,19) + POWER(x3,19) + 
      ...
      x94,19) + POWER(x95,19) + POWER(x96,19) + POWER(x97,19) + POWER(x98,19)
       + POWER(x99,19) + POWER(x100,19)) =E= 0;

e20.. sqr((-6.27856193472058) + POWER(x1,20) + POWER(x2,20) + POWER(x3,20) + 
      ...
      x94,20) + POWER(x95,20) + POWER(x96,20) + POWER(x97,20) + POWER(x98,20)
       + POWER(x99,20) + POWER(x100,20)) =E= 0;

e21.. sqr((-6.06294347019137) + POWER(x1,21) + POWER(x2,21) + POWER(x3,21) + 
      ...
      x94,21) + POWER(x95,21) + POWER(x96,21) + POWER(x97,21) + POWER(x98,21)
       + POWER(x99,21) + POWER(x100,21)) =E= 0;

e22.. sqr((-5.86614659739942) + POWER(x1,22) + POWER(x2,22) + POWER(x3,22) + 
      ...
      x94,22) + POWER(x95,22) + POWER(x96,22) + POWER(x97,22) + POWER(x98,22)
       + POWER(x99,22) + POWER(x100,22)) =E= 0;

e23.. sqr((-5.68581858834257) + POWER(x1,23) + POWER(x2,23) + POWER(x3,23) + 
      ...
      x94,23) + POWER(x95,23) + POWER(x96,23) + POWER(x97,23) + POWER(x98,23)
       + POWER(x99,23) + POWER(x100,23)) =E= 0;

e24.. sqr((-5.51998315018559) + POWER(x1,24) + POWER(x2,24) + POWER(x3,24) + 
      ...
      x94,24) + POWER(x95,24) + POWER(x96,24) + POWER(x97,24) + POWER(x98,24)
       + POWER(x99,24) + POWER(x100,24)) =E= 0;

e25.. sqr((-5.36696803388383) + POWER(x1,25) + POWER(x2,25) + POWER(x3,25) + 
      ...
      x94,25) + POWER(x95,25) + POWER(x96,25) + POWER(x97,25) + POWER(x98,25)
       + POWER(x99,25) + POWER(x100,25)) =E= 0;

e26.. sqr((-5.22534872977949) + POWER(x1,26) + POWER(x2,26) + POWER(x3,26) + 
      ...
      x94,26) + POWER(x95,26) + POWER(x96,26) + POWER(x97,26) + POWER(x98,26)
       + POWER(x99,26) + POWER(x100,26)) =E= 0;

e27.. sqr((-5.09390422842732) + POWER(x1,27) + POWER(x2,27) + POWER(x3,27) + 
      ...
      x94,27) + POWER(x95,27) + POWER(x96,27) + POWER(x97,27) + POWER(x98,27)
       + POWER(x99,27) + POWER(x100,27)) =E= 0;

e28.. sqr((-4.97158193435301) + POWER(x1,28) + POWER(x2,28) + POWER(x3,28) + 
      ...
      x94,28) + POWER(x95,28) + POWER(x96,28) + POWER(x97,28) + POWER(x98,28)
       + POWER(x99,28) + POWER(x100,28)) =E= 0;

e29.. sqr((-4.85746959706004) + POWER(x1,29) + POWER(x2,29) + POWER(x3,29) + 
      ...
      x94,29) + POWER(x95,29) + POWER(x96,29) + POWER(x97,29) + POWER(x98,29)
       + POWER(x99,29) + POWER(x100,29)) =E= 0;

e30.. sqr((-4.75077267474485) + POWER(x1,30) + POWER(x2,30) + POWER(x3,30) + 
      ...
      x94,30) + POWER(x95,30) + POWER(x96,30) + POWER(x97,30) + POWER(x98,30)
       + POWER(x99,30) + POWER(x100,30)) =E= 0;

e31.. sqr((-4.65079594231559) + POWER(x1,31) + POWER(x2,31) + POWER(x3,31) + 
      ...
      x94,31) + POWER(x95,31) + POWER(x96,31) + POWER(x97,31) + POWER(x98,31)
       + POWER(x99,31) + POWER(x100,31)) =E= 0;

e32.. sqr((-4.55692844340744) + POWER(x1,32) + POWER(x2,32) + POWER(x3,32) + 
      ...
      x94,32) + POWER(x95,32) + POWER(x96,32) + POWER(x97,32) + POWER(x98,32)
       + POWER(x99,32) + POWER(x100,32)) =E= 0;

e33.. sqr((-4.46863109792481) + POWER(x1,33) + POWER(x2,33) + POWER(x3,33) + 
      ...
      x94,33) + POWER(x95,33) + POWER(x96,33) + POWER(x97,33) + POWER(x98,33)
       + POWER(x99,33) + POWER(x100,33)) =E= 0;

e34.. sqr((-4.38542643400482) + POWER(x1,34) + POWER(x2,34) + POWER(x3,34) + 
      ...
      x94,34) + POWER(x95,34) + POWER(x96,34) + POWER(x97,34) + POWER(x98,34)
       + POWER(x99,34) + POWER(x100,34)) =E= 0;

e35.. sqr((-4.30689003132034) + POWER(x1,35) + POWER(x2,35) + POWER(x3,35) + 
      ...
      x94,35) + POWER(x95,35) + POWER(x96,35) + POWER(x97,35) + POWER(x98,35)
       + POWER(x99,35) + POWER(x100,35)) =E= 0;

e36.. sqr((-4.23264335195559) + POWER(x1,36) + POWER(x2,36) + POWER(x3,36) + 
      ...
      x94,36) + POWER(x95,36) + POWER(x96,36) + POWER(x97,36) + POWER(x98,36)
       + POWER(x99,36) + POWER(x100,36)) =E= 0;

e37.. sqr((-4.16234770324872) + POWER(x1,37) + POWER(x2,37) + POWER(x3,37) + 
      ...
      x94,37) + POWER(x95,37) + POWER(x96,37) + POWER(x97,37) + POWER(x98,37)
       + POWER(x99,37) + POWER(x100,37)) =E= 0;

e38.. sqr((-4.09569912942795) + POWER(x1,38) + POWER(x2,38) + POWER(x3,38) + 
      ...
      x94,38) + POWER(x95,38) + POWER(x96,38) + POWER(x97,38) + POWER(x98,38)
       + POWER(x99,38) + POWER(x100,38)) =E= 0;

e39.. sqr((-4.03242406950239) + POWER(x1,39) + POWER(x2,39) + POWER(x3,39) + 
      ...
      x94,39) + POWER(x95,39) + POWER(x96,39) + POWER(x97,39) + POWER(x98,39)
       + POWER(x99,39) + POWER(x100,39)) =E= 0;

e40.. sqr((-3.97227565058344) + POWER(x1,40) + POWER(x2,40) + POWER(x3,40) + 
      ...
      x94,40) + POWER(x95,40) + POWER(x96,40) + POWER(x97,40) + POWER(x98,40)
       + POWER(x99,40) + POWER(x100,40)) =E= 0;

e41.. sqr((-3.91503051073177) + POWER(x1,41) + POWER(x2,41) + POWER(x3,41) + 
      ...
      x94,41) + POWER(x95,41) + POWER(x96,41) + POWER(x97,41) + POWER(x98,41)
       + POWER(x99,41) + POWER(x100,41)) =E= 0;

e42.. sqr((-3.86048606512811) + POWER(x1,42) + POWER(x2,42) + POWER(x3,42) + 
      ...
      x94,42) + POWER(x95,42) + POWER(x96,42) + POWER(x97,42) + POWER(x98,42)
       + POWER(x99,42) + POWER(x100,42)) =E= 0;

e43.. sqr((-3.80845814503886) + POWER(x1,43) + POWER(x2,43) + POWER(x3,43) + 
      ...
      x94,43) + POWER(x95,43) + POWER(x96,43) + POWER(x97,43) + POWER(x98,43)
       + POWER(x99,43) + POWER(x100,43)) =E= 0;

e44.. sqr((-3.75877895158644) + POWER(x1,44) + POWER(x2,44) + POWER(x3,44) + 
      ...
      x94,44) + POWER(x95,44) + POWER(x96,44) + POWER(x97,44) + POWER(x98,44)
       + POWER(x99,44) + POWER(x100,44)) =E= 0;

e45.. sqr((-3.71129527641913) + POWER(x1,45) + POWER(x2,45) + POWER(x3,45) + 
      ...
      x94,45) + POWER(x95,45) + POWER(x96,45) + POWER(x97,45) + POWER(x98,45)
       + POWER(x99,45) + POWER(x100,45)) =E= 0;

e46.. sqr((-3.66586694952954) + POWER(x1,46) + POWER(x2,46) + POWER(x3,46) + 
      ...
      x94,46) + POWER(x95,46) + POWER(x96,46) + POWER(x97,46) + POWER(x98,46)
       + POWER(x99,46) + POWER(x100,46)) =E= 0;

e47.. sqr((-3.62236548109576) + POWER(x1,47) + POWER(x2,47) + POWER(x3,47) + 
      ...
      x94,47) + POWER(x95,47) + POWER(x96,47) + POWER(x97,47) + POWER(x98,47)
       + POWER(x99,47) + POWER(x100,47)) =E= 0;

e48.. sqr((-3.58067286962777) + POWER(x1,48) + POWER(x2,48) + POWER(x3,48) + 
      ...
      x94,48) + POWER(x95,48) + POWER(x96,48) + POWER(x97,48) + POWER(x98,48)
       + POWER(x99,48) + POWER(x100,48)) =E= 0;

e49.. sqr((-3.54068055313631) + POWER(x1,49) + POWER(x2,49) + POWER(x3,49) + 
      ...
      x94,49) + POWER(x95,49) + POWER(x96,49) + POWER(x97,49) + POWER(x98,49)
       + POWER(x99,49) + POWER(x100,49)) =E= 0;

e50.. sqr((-3.50228848369365) + POWER(x1,50) + POWER(x2,50) + POWER(x3,50) + 
      ...
      x94,50) + POWER(x95,50) + POWER(x96,50) + POWER(x97,50) + POWER(x98,50)
       + POWER(x99,50) + POWER(x100,50)) =E= 0;

e51.. sqr((-3.46540430877591) + POWER(x1,51) + POWER(x2,51) + POWER(x3,51) + 
      ...
      x94,51) + POWER(x95,51) + POWER(x96,51) + POWER(x97,51) + POWER(x98,51)
       + POWER(x99,51) + POWER(x100,51)) =E= 0;

e52.. sqr((-3.42994264528358) + POWER(x1,52) + POWER(x2,52) + POWER(x3,52) + 
      ...
      x94,52) + POWER(x95,52) + POWER(x96,52) + POWER(x97,52) + POWER(x98,52)
       + POWER(x99,52) + POWER(x100,52)) =E= 0;

e53.. sqr((-3.39582443422652) + POWER(x1,53) + POWER(x2,53) + POWER(x3,53) + 
      ...
      x94,53) + POWER(x95,53) + POWER(x96,53) + POWER(x97,53) + POWER(x98,53)
       + POWER(x99,53) + POWER(x100,53)) =E= 0;

e54.. sqr((-3.362976365807) + POWER(x1,54) + POWER(x2,54) + POWER(x3,54) + 
      ...
      x94,54) + POWER(x95,54) + POWER(x96,54) + POWER(x97,54) + POWER(x98,54)
       + POWER(x99,54) + POWER(x100,54)) =E= 0;

e55.. sqr((-3.33133036610093) + POWER(x1,55) + POWER(x2,55) + POWER(x3,55) + 
      ...
      x94,55) + POWER(x95,55) + POWER(x96,55) + POWER(x97,55) + POWER(x98,55)
       + POWER(x99,55) + POWER(x100,55)) =E= 0;

e56.. sqr((-3.3008231377728) + POWER(x1,56) + POWER(x2,56) + POWER(x3,56) + 
      ...
      x94,56) + POWER(x95,56) + POWER(x96,56) + POWER(x97,56) + POWER(x98,56)
       + POWER(x99,56) + POWER(x100,56)) =E= 0;

e57.. sqr((-3.27139574830284) + POWER(x1,57) + POWER(x2,57) + POWER(x3,57) + 
      ...
      x94,57) + POWER(x95,57) + POWER(x96,57) + POWER(x97,57) + POWER(x98,57)
       + POWER(x99,57) + POWER(x100,57)) =E= 0;

e58.. sqr((-3.2429932600894) + POWER(x1,58) + POWER(x2,58) + POWER(x3,58) + 
      ...
      x94,58) + POWER(x95,58) + POWER(x96,58) + POWER(x97,58) + POWER(x98,58)
       + POWER(x99,58) + POWER(x100,58)) =E= 0;

e59.. sqr((-3.21556439754116) + POWER(x1,59) + POWER(x2,59) + POWER(x3,59) + 
      ...
      x94,59) + POWER(x95,59) + POWER(x96,59) + POWER(x97,59) + POWER(x98,59)
       + POWER(x99,59) + POWER(x100,59)) =E= 0;

e60.. sqr((-3.1890612469144) + POWER(x1,60) + POWER(x2,60) + POWER(x3,60) + 
      ...
      x94,60) + POWER(x95,60) + POWER(x96,60) + POWER(x97,60) + POWER(x98,60)
       + POWER(x99,60) + POWER(x100,60)) =E= 0;

e61.. sqr((-3.16343898519829) + POWER(x1,61) + POWER(x2,61) + POWER(x3,61) + 
      ...
      x94,61) + POWER(x95,61) + POWER(x96,61) + POWER(x97,61) + POWER(x98,61)
       + POWER(x99,61) + POWER(x100,61)) =E= 0;

e62.. sqr((-3.13865563482064) + POWER(x1,62) + POWER(x2,62) + POWER(x3,62) + 
      ...
      x94,62) + POWER(x95,62) + POWER(x96,62) + POWER(x97,62) + POWER(x98,62)
       + POWER(x99,62) + POWER(x100,62)) =E= 0;

e63.. sqr((-3.11467184135006) + POWER(x1,63) + POWER(x2,63) + POWER(x3,63) + 
      ...
      x94,63) + POWER(x95,63) + POWER(x96,63) + POWER(x97,63) + POWER(x98,63)
       + POWER(x99,63) + POWER(x100,63)) =E= 0;

e64.. sqr((-3.09145067171795) + POWER(x1,64) + POWER(x2,64) + POWER(x3,64) + 
      ...
      x94,64) + POWER(x95,64) + POWER(x96,64) + POWER(x97,64) + POWER(x98,64)
       + POWER(x99,64) + POWER(x100,64)) =E= 0;

e65.. sqr((-3.06895743078387) + POWER(x1,65) + POWER(x2,65) + POWER(x3,65) + 
      ...
      x94,65) + POWER(x95,65) + POWER(x96,65) + POWER(x97,65) + POWER(x98,65)
       + POWER(x99,65) + POWER(x100,65)) =E= 0;

e66.. sqr((-3.0471594943281) + POWER(x1,66) + POWER(x2,66) + POWER(x3,66) + 
      ...
      x94,66) + POWER(x95,66) + POWER(x96,66) + POWER(x97,66) + POWER(x98,66)
       + POWER(x99,66) + POWER(x100,66)) =E= 0;

e67.. sqr((-3.02602615678001) + POWER(x1,67) + POWER(x2,67) + POWER(x3,67) + 
      ...
      x94,67) + POWER(x95,67) + POWER(x96,67) + POWER(x97,67) + POWER(x98,67)
       + POWER(x99,67) + POWER(x100,67)) =E= 0;

e68.. sqr((-3.00552849218753) + POWER(x1,68) + POWER(x2,68) + POWER(x3,68) + 
      ...
      x94,68) + POWER(x95,68) + POWER(x96,68) + POWER(x97,68) + POWER(x98,68)
       + POWER(x99,68) + POWER(x100,68)) =E= 0;

e69.. sqr((-2.98563922710361) + POWER(x1,69) + POWER(x2,69) + POWER(x3,69) + 
      ...
      x94,69) + POWER(x95,69) + POWER(x96,69) + POWER(x97,69) + POWER(x98,69)
       + POWER(x99,69) + POWER(x100,69)) =E= 0;

e70.. sqr((-2.96633262421456) + POWER(x1,70) + POWER(x2,70) + POWER(x3,70) + 
      ...
      x94,70) + POWER(x95,70) + POWER(x96,70) + POWER(x97,70) + POWER(x98,70)
       + POWER(x99,70) + POWER(x100,70)) =E= 0;

e71.. sqr((-2.94758437566617) + POWER(x1,71) + POWER(x2,71) + POWER(x3,71) + 
      ...
      x94,71) + POWER(x95,71) + POWER(x96,71) + POWER(x97,71) + POWER(x98,71)
       + POWER(x99,71) + POWER(x100,71)) =E= 0;

e72.. sqr((-2.92937150515754) + POWER(x1,72) + POWER(x2,72) + POWER(x3,72) + 
      ...
      x94,72) + POWER(x95,72) + POWER(x96,72) + POWER(x97,72) + POWER(x98,72)
       + POWER(x99,72) + POWER(x100,72)) =E= 0;

e73.. sqr((-2.91167227797319) + POWER(x1,73) + POWER(x2,73) + POWER(x3,73) + 
      ...
      x94,73) + POWER(x95,73) + POWER(x96,73) + POWER(x97,73) + POWER(x98,73)
       + POWER(x99,73) + POWER(x100,73)) =E= 0;

e74.. sqr((-2.89446611821278) + POWER(x1,74) + POWER(x2,74) + POWER(x3,74) + 
      ...
      x94,74) + POWER(x95,74) + POWER(x96,74) + POWER(x97,74) + POWER(x98,74)
       + POWER(x99,74) + POWER(x100,74)) =E= 0;

e75.. sqr((-2.87773353255517) + POWER(x1,75) + POWER(x2,75) + POWER(x3,75) + 
      ...
      x94,75) + POWER(x95,75) + POWER(x96,75) + POWER(x97,75) + POWER(x98,75)
       + POWER(x99,75) + POWER(x100,75)) =E= 0;

e76.. sqr((-2.86145603996313) + POWER(x1,76) + POWER(x2,76) + POWER(x3,76) + 
      ...
      x94,76) + POWER(x95,76) + POWER(x96,76) + POWER(x97,76) + POWER(x98,76)
       + POWER(x99,76) + POWER(x100,76)) =E= 0;

e77.. sqr((-2.84561610679524) + POWER(x1,77) + POWER(x2,77) + POWER(x3,77) + 
      ...
      x94,77) + POWER(x95,77) + POWER(x96,77) + POWER(x97,77) + POWER(x98,77)
       + POWER(x99,77) + POWER(x100,77)) =E= 0;

e78.. sqr((-2.8301970868462) + POWER(x1,78) + POWER(x2,78) + POWER(x3,78) + 
      ...
      x94,78) + POWER(x95,78) + POWER(x96,78) + POWER(x97,78) + POWER(x98,78)
       + POWER(x99,78) + POWER(x100,78)) =E= 0;

e79.. sqr((-2.81518316588393) + POWER(x1,79) + POWER(x2,79) + POWER(x3,79) + 
      ...
      x94,79) + POWER(x95,79) + POWER(x96,79) + POWER(x97,79) + POWER(x98,79)
       + POWER(x99,79) + POWER(x100,79)) =E= 0;

e80.. sqr((-2.80055931029525) + POWER(x1,80) + POWER(x2,80) + POWER(x3,80) + 
      ...
      x94,80) + POWER(x95,80) + POWER(x96,80) + POWER(x97,80) + POWER(x98,80)
       + POWER(x99,80) + POWER(x100,80)) =E= 0;

e81.. sqr((-2.78631121948908) + POWER(x1,81) + POWER(x2,81) + POWER(x3,81) + 
      ...
      x94,81) + POWER(x95,81) + POWER(x96,81) + POWER(x97,81) + POWER(x98,81)
       + POWER(x99,81) + POWER(x100,81)) =E= 0;

e82.. sqr((-2.77242528174044) + POWER(x1,82) + POWER(x2,82) + POWER(x3,82) + 
      ...
      x94,82) + POWER(x95,82) + POWER(x96,82) + POWER(x97,82) + POWER(x98,82)
       + POWER(x99,82) + POWER(x100,82)) =E= 0;

e83.. sqr((-2.75888853318845) + POWER(x1,83) + POWER(x2,83) + POWER(x3,83) + 
      ...
      x94,83) + POWER(x95,83) + POWER(x96,83) + POWER(x97,83) + POWER(x98,83)
       + POWER(x99,83) + POWER(x100,83)) =E= 0;

e84.. sqr((-2.74568861972864) + POWER(x1,84) + POWER(x2,84) + POWER(x3,84) + 
      ...
      x94,84) + POWER(x95,84) + POWER(x96,84) + POWER(x97,84) + POWER(x98,84)
       + POWER(x99,84) + POWER(x100,84)) =E= 0;

e85.. sqr((-2.7328137615639) + POWER(x1,85) + POWER(x2,85) + POWER(x3,85) + 
      ...
      x94,85) + POWER(x95,85) + POWER(x96,85) + POWER(x97,85) + POWER(x98,85)
       + POWER(x99,85) + POWER(x100,85)) =E= 0;

e86.. sqr((-2.72025272020027) + POWER(x1,86) + POWER(x2,86) + POWER(x3,86) + 
      ...
      x94,86) + POWER(x95,86) + POWER(x96,86) + POWER(x97,86) + POWER(x98,86)
       + POWER(x99,86) + POWER(x100,86)) =E= 0;

e87.. sqr((-2.70799476769297) + POWER(x1,87) + POWER(x2,87) + POWER(x3,87) + 
      ...
      x94,87) + POWER(x95,87) + POWER(x96,87) + POWER(x97,87) + POWER(x98,87)
       + POWER(x99,87) + POWER(x100,87)) =E= 0;

e88.. sqr((-2.69602965796581) + POWER(x1,88) + POWER(x2,88) + POWER(x3,88) + 
      ...
      x94,88) + POWER(x95,88) + POWER(x96,88) + POWER(x97,88) + POWER(x98,88)
       + POWER(x99,88) + POWER(x100,88)) =E= 0;

e89.. sqr((-2.68434760004258) + POWER(x1,89) + POWER(x2,89) + POWER(x3,89) + 
      ...
      x94,89) + POWER(x95,89) + POWER(x96,89) + POWER(x97,89) + POWER(x98,89)
       + POWER(x99,89) + POWER(x100,89)) =E= 0;

e90.. sqr((-2.67293923304349) + POWER(x1,90) + POWER(x2,90) + POWER(x3,90) + 
      ...
      x94,90) + POWER(x95,90) + POWER(x96,90) + POWER(x97,90) + POWER(x98,90)
       + POWER(x99,90) + POWER(x100,90)) =E= 0;

e91.. sqr((-2.66179560281226) + POWER(x1,91) + POWER(x2,91) + POWER(x3,91) + 
      ...
      x94,91) + POWER(x95,91) + POWER(x96,91) + POWER(x97,91) + POWER(x98,91)
       + POWER(x99,91) + POWER(x100,91)) =E= 0;

e92.. sqr((-2.65090814005114) + POWER(x1,92) + POWER(x2,92) + POWER(x3,92) + 
      ...
      x94,92) + POWER(x95,92) + POWER(x96,92) + POWER(x97,92) + POWER(x98,92)
       + POWER(x99,92) + POWER(x100,92)) =E= 0;

e93.. sqr((-2.64026863985162) + POWER(x1,93) + POWER(x2,93) + POWER(x3,93) + 
      ...
      x94,93) + POWER(x95,93) + POWER(x96,93) + POWER(x97,93) + POWER(x98,93)
       + POWER(x99,93) + POWER(x100,93)) =E= 0;

e94.. sqr((-2.62986924251787) + POWER(x1,94) + POWER(x2,94) + POWER(x3,94) + 
      ...
      x94,94) + POWER(x95,94) + POWER(x96,94) + POWER(x97,94) + POWER(x98,94)
       + POWER(x99,94) + POWER(x100,94)) =E= 0;

e95.. sqr((-2.61970241558886) + POWER(x1,95) + POWER(x2,95) + POWER(x3,95) + 
      ...
      x94,95) + POWER(x95,95) + POWER(x96,95) + POWER(x97,95) + POWER(x98,95)
       + POWER(x99,95) + POWER(x100,95)) =E= 0;

e96.. sqr((-2.6097609369724) + POWER(x1,96) + POWER(x2,96) + POWER(x3,96) + 
      ...
      x94,96) + POWER(x95,96) + POWER(x96,96) + POWER(x97,96) + POWER(x98,96)
       + POWER(x99,96) + POWER(x100,96)) =E= 0;

e97.. sqr((-2.60003787911185) + POWER(x1,97) + POWER(x2,97) + POWER(x3,97) + 
      ...
      x94,97) + POWER(x95,97) + POWER(x96,97) + POWER(x97,97) + POWER(x98,97)
       + POWER(x99,97) + POWER(x100,97)) =E= 0;

e98.. sqr((-2.59052659411245) + POWER(x1,98) + POWER(x2,98) + POWER(x3,98) + 
      ...
      x94,98) + POWER(x95,98) + POWER(x96,98) + POWER(x97,98) + POWER(x98,98)
       + POWER(x99,98) + POWER(x100,98)) =E= 0;

e99.. sqr((-2.58122069976007) + POWER(x1,99) + POWER(x2,99) + POWER(x3,99) + 
      ...
      x94,99) + POWER(x95,99) + POWER(x96,99) + POWER(x97,99) + POWER(x98,99)
       + POWER(x99,99) + POWER(x100,99)) =E= 0;

e100.. sqr((-2.57211406637055) + POWER(x1,100) + POWER(x2,100) + POWER(x3,100)
