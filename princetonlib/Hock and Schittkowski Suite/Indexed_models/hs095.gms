$Set N 6
Set I /i1*i%N%/;
Parameter u(i) /i1   0.31,i2  0.046 ,i3  0.068,i4 0.042,i5 0.028,i6  0.0134/;

Positive Variable x(i)  ;
         Variable   obj ;
Equation constr1 , constr2 , constr3 , constr4 , def_obj ;

Def_obj.. obj=e=4.3*x['i1'] + 31.8*x['i2'] + 63.3*x['i3'] + 15.8*x['i4'] + 68.5*x['i5'] +4.7*x['i6'];
...
constr3.. -273*x['i2'] - 70*x['i4'] - 819*x['i5'] + 26000*x['i4']*x['i5']
          =g= -29.08;
...
Solve hs095 using nlp minimazing obj ;
