* Objective: linear
* Constraints: nonconvex quadratic
* Feasible set: convex
...
defobj.. b_pattern =e=  t                     ;

t_bnds(i)$DEGS1(i)..
    sqr(G_real[i]) + sqr(G_imag[i]) =l= sqr(t);
...
Model antenna_nonconvex /all/;
Solve antenna_nonconvex using nlp minimize b_pattern;
display b_pattern.l ;