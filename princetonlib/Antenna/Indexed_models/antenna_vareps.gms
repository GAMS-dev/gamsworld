...
defobj.. b_pattern =e= epsilon + 100*t ;

t_bnds(i)$DEGS1(i)..
 sqrt(sqr(epsilon) + sqr(G_real[i]) + sqr(G_imag[i])) =l= t;
...
Model antenna_vareps /all/;
Solve antenna_vareps using nlp minimize b_pattern;
display b_pattern.l ;