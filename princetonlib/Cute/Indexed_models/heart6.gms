...
cons1.. (t * a + u * (-0.816-a) - v * c - w * (-0.017-c) + 1.826) =e= 0;
cons2.. (v * a + w * (-0.816-a) + t * c + u * (-0.017-c) + 0.754) =e= 0;
cons3.. (a * (t*t-v*v) - 2.0*c * t * v + (-0.816-a) * (u*u-w*w) -
         2.0*(-0.017-c) *u * w + 4.839) =e= 0;
cons4.. (c * (t*t-v*v) + 2.0*a * t * v + (-0.017-c) * (u*u-w*w) +
         2.0*(-0.816-a) *u * w + 3.259) =e= 0;
cons5.. (a * t * (t*t-(3.0)*v*v) + c * v * (v*v-(3.0)*t*t) +
        (-0.816-a) * u *(u*u-(3.0)*w*w) +(-0.017-c) * w * (w*w-(3.0)*u*u) +
        14.023) =e= 0 ;
cons6.. (c * t * (t*t-(3.0)*v*v) - a * v * (v*v-(3.0)*t*t) +
        (-0.017-c) * u *(u*u-(3.0)*w*w) -(-0.816-a) * w * (w*w-(3.0)*u*u) -
        15.467) =e= 0 ;
...
Model heart6 /all/;
Solve heart6 using nlp minimize obj;

display a.l ; display c.l ; display   t.l ; display u.l ;
