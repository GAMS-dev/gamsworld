...
Parameter    xi1;    xi1 = (8.0) * (1.0 / (9.0));
Parameter   sxi1;   sxi1 = sin(9.2 * ((8.0) * (1.0 / (9.0))));
Parameter    jm1;    jm1 = -1 + (9);
Parameter   rjm1;   rjm1 = 8.0;
Parameter    xi2;    xi2 = (8.0) * (1.0 / (9.0));
Parameter   sxi2;   sxi2 = sin(9.3 * ((8.0) * (1.0 / (9.0))));
Parameter     l1;     l1 = (sin(9.2 * ((8.0) * (1.0 / (9.0))))) * (sin(9.3*
                           ((8.0) * (1.0 /(9.0)))));
Parameter     l2;     l2 = ((sin(9.2 * ((8.0) * (1.0 / (9))))) *
                           (sin(9.3* ((8.0) * (1.0/(9.0)))))) * ((sin(9.2 *
                           ((8.0) * (1.0 / (9.0))))) * (sin(9.3* ((8.0) *
                           (1.0 /(9.0))))));
Parameter    low;    low = (((sin(9.2*(8*(1/9)))) *(sin(9.3*(8*(1/9)))))*
                           ((sin(9.2*(8*(1/9)))) *(sin(9.3*(8*(1/9))))))*
                           ((sin(9.2*(8*(1/9))))*(sin(9.3*(8*(1/9)))));
...
Variable x5_2 , x6_2 , x7_2 , x5_3 , x6_3 ,
         x7_3 , x5_4 , x6_4 , x7_4 , x2_5 ,
         x3_5 , x4_5 , x8_5 , x9_5 , x2_6 ,
         x3_6 , x4_6 , x8_6 , x9_6 , x2_7 ,
         x3_7 , x4_7 , x8_7 , x9_7 , x5_8 ,
         x6_8 , x7_8 , x5_9 , x6_9 , x7_9 , obj ;

Equation Def_obj ;

              Def_obj..  obj =e= 0.25*(x3_2-x2_2) * (x3_2-x2_2) +
              0.25*(x2_3-x2_2) * (x2_3- x2_2) + 0.25*(x1_2-x2_2) *
              (x1_2-x2_2) + 0.25*(x2_1-x2_2) * (x2_1- x2_2) -
              ...
              0.25*(x3_3-x3_2) * (x3_3-x3_2) + 0.25*(x2_2-x3_2) * (x2_2-
              x3_2) + 0.25*(x3_1-x3_2) * (x3_1-x3_2) -
              ...
              0.25*(x6_3-x6_2) * (x6_3-x6_2) + 0.25*(x5_2-x6_2) * (x5_2-
              x6_2) + 0.25*(x6_1-x6_2) * (x6_1-x6_2) -
              ...
              + 0.25*(x9_3-x9_2) * (x9_3-x9_2) + 0.25*(x8_2-x9_2) * (x8_2-
              x9_2) + 0.25*(x9_1-x9_2) * (x9_1-x9_2) -
              0.012345679012345678*x9_2 + 0.25*(x10_3-x9_3) * (x10_3-x9_3)
              + 0.25*(x9_4-x9_3) * (x9_4-x9_3) + 0.25*(x8_3- x9_3) *
              (x8_3-x9_3) + 0.25*(x9_2-x9_3) * (x9_2-x9_3) -
              0.012345679012345678*x9_3 + 0.25*(x10_4-x9_4) * (x10_4-x9_4)
              + 0.25*(x9_5-x9_4) * (x9_5- x9_4) + 0.25*(x8_4-x9_4) *
              (x8_4-x9_4) + 0.25*(x9_3-x9_4) * (x9_3- x9_4) -
              0.012345679012345678*x9_4 + 0.25*(x10_5-x9_5) * (x10_5-x9_5)
              + 0.25*(x9_6-x9_5) * (x9_6-x9_5) + 0.25*(x8_5-x9_5) *
              (x8_5-x9_5) + 0.25*(x9_4- x9_5) * (x9_4-x9_5) -
              0.012345679012345678*x9_5 + 0.25*(x10_6-x9_6) * (x10_6- x9_6)
              + 0.25*(x9_7-x9_6) * (x9_7-x9_6) + 0.25*(x8_6-x9_6) * (x8_6-
              x9_6) + 0.25*(x9_5-x9_6) * (x9_5-x9_6) -
              0.012345679012345678*x9_6 + 0.25*(x10_7-x9_7) * (x10_7-x9_7)
              + 0.25*(x9_8-x9_7) * (x9_8-x9_7) + 0.25*(x8_7- x9_7) *
              (x8_7-x9_7) + 0.25*(x9_6-x9_7) * (x9_6-x9_7) -
              0.012345679012345678*x9_7 + 0.25*(x10_8-x9_8) * (x10_8-x9_8)
              + 0.25*(x9_9-x9_8) * (x9_9- x9_8) + 0.25*(x8_8-x9_8) *
              (x8_8-x9_8) + 0.25*(x9_7-x9_8) * (x9_7- x9_8) -
              0.012345679012345678*x9_8 + 0.25*(x10_9-x9_9) * (x10_9-x9_9)
              + 0.25*(x9_10-x9_9) * (x9_10-x9_9) + 0.25*(x8_9-x9_9) *
              (x8_9- x9_9) + 0.25*(x9_8-x9_9) * (x9_8-x9_9) -
...
x10_10.up=0.0 ;
 ...
 x2_2.l = 0.3937793366356831    ;
 x3_2.l = 0.44671816460760055   ;
 x4_2.l = 2.658723886528665e-4  ;
 x5_2.l =-0.3391611563540678    ;
 x6_2.l =-0.4960928025216343    ;
 x7_2.l =-0.0021091266848867365 ;
 x8_2.l = 0.2847312063379939    ;
 x9_2.l = 0.5400916195594984    ;
 x2_3.l = 0.4227141086543548    ;
 x3_3.l = 0.4795428637397414    ;
 x4_3.l = 2.854086015416797e-4  ;
 x5_3.l =-0.36408260302147705   ;
 x6_3.l =-0.5325455332913744    ;
 x7_3.l =-0.0022641045979156157 ;
 x8_3.l = 0.30565315875017296   ;
 x9_3.l = 0.5797773684732547    ;
 x2_4.l = 4.466137010418048e-5  ;
 x3_4.l = 5.0665546476499324e-5 ;
 x4_4.l = 3.0154515601447075e-8 ;
 x5_4.l =-3.846672620840164e-5  ;
 x6_4.l =-5.626548220821779e-5  ;
 x7_4.l =-2.3921135190869225e-7 ;
 x8_4.l = 3.229343087201135e-5  ;
 x9_4.l = 6.125570711098406e-5  ;
 x2_5.l =-0.3642526902031173    ;
 x3_5.l =-0.41322202076708053   ;
 x4_5.l =-2.4593655331166914e-4 ;
 x5_5.l = 0.3137299297364258    ;
 x6_5.l = 0.4588944139445591    ;
 x7_5.l = 0.0019509786255238442 ;
 x8_5.l =-0.2633812855176486    ;
 x9_5.l =-0.49959407992684074   ;
 x2_6.l =-0.4507393756992777    ;
 x3_6.l =-0.5113357860497522    ;
 x4_6.l =-3.043307338087716e-4  ;
 x5_6.l = 0.3882206953330132    ;
 x6_6.l = 0.5678524475355717    ;
 x7_6.l = 0.002414211099390602  ;
 x8_6.l =-0.3259174726723327    ;
 x9_6.l =-0.618215677593785     ;
 x2_7.l =-3.5636475335626487e-4 ;
 x3_7.l =-4.0427364703860696e-4 ;
 x4_7.l =-2.4061076697424153e-7 ;
 x5_7.l = 3.0693606948696984e-4 ;
 x6_7.l = 4.489569989194305e-4  ;
 x7_7.l = 1.9087299432173126e-6 ;
 x8_7.l =-2.576777313568063e-4  ;
 x9_7.l =-4.887753086246255e-4  ;
 x2_8.l = 0.3344514359720908    ;
 x3_8.l = 0.37941435145962443   ;
 x4_8.l = 2.2581530795900886e-4 ;
 x5_8.l =-0.28806218410977386   ;
 x6_8.l =-0.4213500677723075    ;
 x7_8.l =-0.001791359735719315  ;
 x8_8.l = 0.24183280321260603   ;
 x9_8.l = 0.45871989947833597   ;
 x2_9.l = 0.4775418533990749    ;
 x3_9.l = 0.5417415299043793    ;
 x4_9.l = 3.224272617493759e-4  ;
 x5_9.l =-0.41130560224428553   ;
 x6_9.l =-0.6016188619701556    ;
 x7_9.l =-0.0025577682027690973 ;
 x8_9.l = 0.3452976206341617    ;
 x9_9.l = 0.6549768589009787    ;

Model obstclbl /all/ ;

Solve obstclbl using nlp minimazing obj ;
