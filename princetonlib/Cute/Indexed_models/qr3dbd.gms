...
Variable q1_1  ,   q1_2  ,   q1_3  ,   q1_4  ,  q1_5  ,   q1_6  ,
        ...
        q10_7  ,  q10_8  ,  q10_9  , q10_10  ,
        r1_1   ,  r1_2   ,   r1_3  ,  r2_2   ,  r2_3  ,   r2_4   ,
        r3_3   ,  r3_4   ,   r3_5  ,  r4_4   ,  r4_5  ,   r4_6   ,
        r5_5   ,  r5_6   ,   r5_7  ,  r6_6   ,  r6_7  ,   r6_8   ,
        r7_7   ,  r7_8   ,   r7_9  ,  r8_8   ,  r8_9  ,  r8_10   ,
        r9_9   , r9_10   , r10_10  ,   obj ;
...
Def_obj.. obj =e= sqr(q1_1 * q1_1 + q1_2 * q1_2 + q1_3 * q1_3 + q1_4 * q1_4 +
                  ...
                  sqr(q1_2 * r2_4 + q1_3 * r3_4 + q1_4 * r4_4) +
                  sqr(q1_3 * r3_5 + q1_4 * r4_5 + q1_5 * r5_5) +
                  sqr(q1_4 * r4_6 + q1_5 * r5_6 + q1_6 * r6_6) +
                  sqr(q1_5 * r5_7 + q1_6 * r6_7 + q1_7 * r7_7) +
                  sqr(q1_6 * r6_8 + q1_7 * r7_8 + q1_8 * r8_8) +
                  sqr(q1_7 * r7_9 + q1_8 * r8_9 + q1_9 * r9_9) +
                  sqr(q1_8 * r8_10 + q1_9 * r9_10 + q1_10 * r10_10) +
                  sqr(q2_1 * r1_1 + 0.1) +
                  sqr(q2_1 * r1_2 + q2_2 * r2_2 - 0.4) +
                  sqr(q2_1 * r1_3 + q2_2 * r2_3 + q2_3 * r3_3 + 0.1) +
                  sqr(q2_2 * r2_4 + q2_3 * r3_4 + q2_4 * r4_4) +
                  sqr(q2_3 * r3_5 + q2_4 * r4_5 + q2_5 * r5_5) +
                  sqr(q2_4 * r4_6 + q2_5 * r5_6 + q2_6 * r6_6) +
                  sqr(q2_5 * r5_7 + q2_6 * r6_7 + q2_7 * r7_7) +
                  sqr(q2_6 * r6_8 + q2_7 * r7_8 + q2_8 * r8_8) +
                  sqr(q2_7 * r7_9 + q2_8 * r8_9 + q2_9 * r9_9) +
                  sqr(q2_8 * r8_10 + q2_9 * r9_10 + q2_10 * r10_10) +
                  sqr(q3_1 * r1_1) +
                  sqr(q3_1 * r1_2 + q3_2 * r2_2 + 0.2) +
                  sqr(q3_1 * r1_3 + q3_2 * r2_3 + q3_3 * r3_3 - 0.6) +
                  sqr(q3_2 * r2_4 + q3_3 * r3_4 + q3_4 * r4_4 + 0.2) +
                  sqr(q3_3 * r3_5 + q3_4 * r4_5 + q3_5 * r5_5) +
                  sqr(q3_4 * r4_6 + q3_5 * r5_6 + q3_6 * r6_6) +
                  sqr(q3_5 * r5_7 + q3_6 * r6_7 + q3_7 * r7_7) +
                  sqr(q3_6 * r6_8 + q3_7 * r7_8 + q3_8 * r8_8) +
                  sqr(q3_7 * r7_9 + q3_8 * r8_9 + q3_9 * r9_9) +
                  sqr(q3_8 * r8_10 + q3_9 * r9_10 + q3_10 * r10_10) +
                  sqr(q4_1 * r1_1) +
                  sqr(q4_1 * r1_2 + q4_2 * r2_2) +
                  sqr(q4_1 * r1_3 + q4_2 * r2_3 + q4_3 * r3_3 + 0.3) +
                  sqr(q4_2 * r2_4 + q4_3 * r3_4 + q4_4 * r4_4 - 0.8) +
                  sqr(q4_3 * r3_5 + q4_4 * r4_5 + q4_5 * r5_5 + 0.3) +
                  sqr(q4_4 * r4_6 + q4_5 * r5_6 + q4_6 * r6_6) +
                  sqr(q4_5 * r5_7 + q4_6 * r6_7 + q4_7 * r7_7) +
                  sqr(q4_6 * r6_8 + q4_7 * r7_8 + q4_8 * r8_8) +
                  sqr(q4_7 * r7_9 + q4_8 * r8_9 + q4_9 * r9_9) +
                  sqr(q4_8 * r8_10 + q4_9 * r9_10 + q4_10 * r10_10) +
                  sqr(q5_1 * r1_1) +
                  sqr(q5_1 * r1_2 + q5_2 * r2_2) +
                  sqr(q5_1 * r1_3 + q5_2 * r2_3 + q5_3 * r3_3) +
                  sqr(q5_2 * r2_4 + q5_3 * r3_4 + q5_4 * r4_4 + 0.4) +
                  sqr(q5_3 * r3_5 + q5_4 * r4_5 + q5_5 * r5_5 - 1.0) +
                  sqr(q5_4 * r4_6 + q5_5 * r5_6 + q5_6 * r6_6 + 0.4) +
                  sqr(q5_5 * r5_7 + q5_6 * r6_7 + q5_7 * r7_7) +
                  sqr(q5_6 * r6_8 + q5_7 * r7_8 + q5_8 * r8_8) +
                  sqr(q5_7 * r7_9 + q5_8 * r8_9 + q5_9 * r9_9) +
                  sqr(q5_8 * r8_10 + q5_9 * r9_10 + q5_10 * r10_10) +
                  sqr(q6_1 * r1_1) +
                  sqr(q6_1 * r1_2 + q6_2 * r2_2) +
                  sqr(q6_1 * r1_3 + q6_2 * r2_3 + q6_3 * r3_3) +
                  sqr(q6_2 * r2_4 + q6_3 * r3_4 + q6_4 * r4_4) +
                  sqr(q6_3 * r3_5 + q6_4 * r4_5 + q6_5 * r5_5 + 0.5) +
                  sqr(q6_4 * r4_6 + q6_5 * r5_6 + q6_6 * r6_6 - 1.2) +
                  sqr(q6_5 * r5_7 + q6_6 * r6_7 + q6_7 * r7_7 + 0.5) +
                  sqr(q6_6 * r6_8 + q6_7 * r7_8 + q6_8 * r8_8) +
                  sqr(q6_7 * r7_9 + q6_8 * r8_9 + q6_9 * r9_9) +
                  sqr(q6_8 * r8_10 + q6_9 * r9_10 + q6_10 * r10_10) +
                  sqr(q7_1 * r1_1) +
                  sqr(q7_1 * r1_2 + q7_2 * r2_2) +
                  sqr(q7_1 * r1_3 + q7_2 * r2_3 + q7_3 * r3_3) +
                  sqr(q7_2 * r2_4 + q7_3 * r3_4 + q7_4 * r4_4) +
                  sqr(q7_3 * r3_5 + q7_4 * r4_5 + q7_5 * r5_5) +
                  sqr(q7_4 * r4_6 + q7_5 * r5_6 + q7_6 * r6_6 + 0.6) +
                  sqr(q7_5 * r5_7 + q7_6 * r6_7 + q7_7 * r7_7 - 1.4) +
                  sqr(q7_6 * r6_8 + q7_7 * r7_8 + q7_8 * r8_8 + 0.6) +
                  sqr(q7_7 * r7_9 + q7_8 * r8_9 + q7_9 * r9_9) +
                  sqr(q7_8 * r8_10 + q7_9 * r9_10 + q7_10 * r10_10) +
                  sqr(q8_1 * r1_1) +
                  sqr(q8_1 * r1_2 + q8_2 * r2_2) +
                  sqr(q8_1 * r1_3 + q8_2 * r2_3 + q8_3 * r3_3) +
                  sqr(q8_2 * r2_4 + q8_3 * r3_4 + q8_4 * r4_4) +
                  sqr(q8_3 * r3_5 + q8_4 * r4_5 + q8_5 * r5_5) +
                  sqr(q8_4 * r4_6 + q8_5 * r5_6 + q8_6 * r6_6) +
                  sqr(q8_5 * r5_7 + q8_6 * r6_7 + q8_7 * r7_7 + 0.7) +
                  sqr(q8_6 * r6_8 + q8_7 * r7_8 + q8_8 * r8_8 - 1.6) +
                  sqr(q8_7 * r7_9 + q8_8 * r8_9 + q8_9 * r9_9 + 0.7) +
                  sqr(q8_8 * r8_10 + q8_9 * r9_10 + q8_10 * r10_10) +
                  sqr(q9_1 * r1_1) +
                  sqr(q9_1 * r1_2 + q9_2 * r2_2) +
                  sqr(q9_1 * r1_3 + q9_2 * r2_3 + q9_3 * r3_3) +
                  sqr(q9_2 * r2_4 + q9_3 * r3_4 + q9_4 * r4_4) +
                  sqr(q9_3 * r3_5 + q9_4 * r4_5 + q9_5 * r5_5) +
                  sqr(q9_4 * r4_6 + q9_5 * r5_6 + q9_6 * r6_6) +
                  sqr(q9_5 * r5_7 + q9_6 * r6_7 + q9_7 * r7_7) +
                  sqr(q9_6 * r6_8 + q9_7 * r7_8 + q9_8 * r8_8 + 0.8) +
                  sqr(q9_7 * r7_9 + q9_8 * r8_9 + q9_9 * r9_9 - 1.8) +
                  sqr(q9_8 * r8_10 + q9_9 * r9_10 + q9_10 * r10_10 + 0.8) +
                  sqr(q10_1 * r1_1) +
                  sqr(q10_1 * r1_2 + q10_2 * r2_2) +
                  sqr(q10_1 * r1_3 + q10_2 * r2_3 + q10_3 * r3_3) +
                  sqr(q10_2 * r2_4 + q10_3 * r3_4 + q10_4 * r4_4) +
                  sqr(q10_3 * r3_5 + q10_4 * r4_5 + q10_5 * r5_5) +
                  sqr(q10_4 * r4_6 + q10_5 * r5_6 + q10_6 * r6_6) +
                  sqr(q10_5 * r5_7 + q10_6 * r6_7 + q10_7 * r7_7) +
                  sqr(q10_6 * r6_8 + q10_7 * r7_8 + q10_8 * r8_8) +
                  sqr(q10_7 * r7_9 + q10_8 * r8_9 + q10_9 * r9_9 + 0.9) +
                  sqr(q10_8 * r8_10 + q10_9 * r9_10 + q10_10 * r10_10 - 20.0);
...
Solve qr3dbd using nlp minimazing obj ;
...
display  r1_1.l ; display  r1_2.l ; display   r1_3.l ; display   r2_2.l ;
display  r2_3.l ; display  r2_4.l ; display   r3_3.l ; display   r3_4.l ;
display  r3_5.l ; display  r4_4.l ; display   r4_5.l ; display   r4_6.l ;
display  r5_5.l ; display  r5_6.l ; display   r5_7.l ; display   r6_6.l ;
display  r6_7.l ; display  r6_8.l ; display   r7_7.l ; display   r7_8.l ;
display  r7_9.l ; display  r8_8.l ; display   r8_9.l ; display  r8_10.l ;
