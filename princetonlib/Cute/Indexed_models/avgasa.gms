...
parameter a[i] /i1  2.0,i2  2.0,i3  2.5,i4  1.5,i5  2.5,i6  2.0,i7  2.5,i8  2.5/ ;
parameter b[i] /i1 -1.0,i2 -2.0,i3 -1.0,i4 -1.0,i5  2.0,i6 -1.0,i7 -2.0        / ;
...
Solve avgasa  using nlp minimize obj;
