...
parameter a(j) /j1 85.334407 ,  j2 0.0056858 ,  j3 0.0006262 ,  j4 0.0022053 ,
                j5 80.51249  ,  j6 0.0071317 ,  j7 0.0029955 ,  j8 0.0021813 ,
                j9  9.300961 , j10 0.0047026 , j11 0.0012547 , j12 0.0019085 /;
...
constr1a.. 0 =l= a['j1'] + a['j2'] *x['i2']*x['i5'] + a['j3'] *x['i1']*x['i4']-                 a['j4'] *x['i3']*x['i5']            ;
...
Solve hs083 using nlp minimize obj;
