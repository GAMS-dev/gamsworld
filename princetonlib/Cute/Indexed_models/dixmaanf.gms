...
parameter  beta;    beta = 0.0625;
parameter gamma;   gamma = 0.0625;
parameter delta;   delta = 0.0625;

parameter K[j] /j1 1,j2 0,j3 0,j4 1/;
...
Solve dixmaanf using nlp minimize f;
