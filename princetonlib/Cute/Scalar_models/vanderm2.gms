...
e1.. sqr((-50.5) + x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 + x10 + x11 + x12
...
e10.. sqr((-9.59924142434241) + POWER(x1,10) + POWER(x2,10) + POWER(x3,10) + 
...
e13.. sqr((-7.65368809336778) + POWER(x1,13) + POWER(x2,13) + POWER(x3,13) + 
...
e16.. sqr((-6.395681609576) + POWER(x1,16) + POWER(x2,16) + POWER(x3,16) + 
...
e18.. sqr((-5.77815109813551) + POWER(x1,18) + POWER(x2,18) + POWER(x3,18) + 
...
e39.. sqr((-3.0324240695024) + POWER(x1,39) + POWER(x2,39) + POWER(x3,39) + 
...
e63.. sqr((-2.11467184135007) + POWER(x1,63) + POWER(x2,63) + POWER(x3,63) + 
...
e78.. sqr((-1.83019708684619) + POWER(x1,78) + POWER(x2,78) + POWER(x3,78) + 
...
e95.. sqr((-1.61970241558887) + POWER(x1,95) + POWER(x2,95) + POWER(x3,95) + 
