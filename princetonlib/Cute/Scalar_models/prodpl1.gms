...
e26..  - (sqr(x4 - x3 + x7 + x8) - 0.1*sqr(x3 + x4)) =G= 0;

e27..  - (sqr(x8 - x7 + x11 + x12) - 0.1*sqr(x7 + x8)) =G= 0;

e28..  - (sqr(x12 - x11 + x15 + x16) - 0.1*sqr(x11 + x12)) =G= 0;

e29..  - (sqr(x16 - x15 + x19 + x20) - 0.1*sqr(x15 + x16)) =G= 0;
