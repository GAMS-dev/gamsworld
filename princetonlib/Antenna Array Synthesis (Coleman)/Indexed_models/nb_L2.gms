...
Set M /m1*m39/;
Set N /n1*n39/;
Parameter Par_Px[m,n] ; Par_Px[m,n] = delta*((ord(m)-20)+(ord(n)-20)/2)/3 ;
Parameter Par_Py[m,n] ; Par_Py[m,n] = delta*(ord(n)-20)*sqrt(3)/3;
...
Solve nb_L2 using nlp minimazing L_two;
Display L_two.l ;