*  MPEC written by GAMS Convert at 11/14/01 10:42:20
*  
*  Equation counts
*     Total       E       G       L       N       X
*       229      77     126      26       0       0
...
e177..    x1 + x186 =G= -51.9671022516769;

e178..    x2 + x187 =G= -31.8616372680017;

e179..    x3 + x188 =G= -11.7561722843265;

e180..    x4 + x189 =G= 8.34929269934863;

e181..    x5 + x190 =G= 28.4547576830238;

e182..    x6 + x191 =G= 47.8926413650383;

e183..    x7 + x192 =G= 40.1589689814284;

e184..    x8 + x193 =G= 32.6149199066612;

e185..    x9 + x194 =G= 30.9929455834451;

e186..    x10 + x195 =G= 36.1127150166764;

e187..    x11 + x196 =G= 41.5760968853861;

e188..    x12 + x197 =G= 27.4485615783093;

e189..    x13 + x198 =G= 13.3650980650625;

e190..    x14 + x199 =G= 0.366844953624352;

e191..    x15 + x200 =G= -8.88297010968856;

e192..    x16 + x201 =G= -12.6153608127892;

e193..    x17 + x202 =G= -9.06134084359033;

e194..    x18 + x203 =G= 3.54807610999485;

e195..    x19 + x204 =G= 26.9818763600534;

e196..    x20 + x205 =G= 51.62316918069;

e197..    x21 + x206 =G= 75.9064200574462;

e198..    x22 + x207 =G= 49.5946235056795;

e199..    x23 + x208 =G= 22.2979679956446;

e200..    x24 + x209 =G= -4.99868751439049;

e201..    x25 + x210 =G= -32.2953430244255;

e202..    x26 + x211 =G= -59.5919985344606;

e203..    x1 - x186 =L= -51.9671022516769;

e204..    x2 - x187 =L= -31.8616372680017;

e205..    x3 - x188 =L= -11.7561722843265;

e206..    x4 - x189 =L= 8.34929269934863;

e207..    x5 - x190 =L= 28.4547576830238;

e208..    x6 - x191 =L= 47.8926413650383;

e209..    x7 - x192 =L= 40.1589689814284;

e210..    x8 - x193 =L= 32.6149199066612;

e211..    x9 - x194 =L= 30.9929455834451;

e212..    x10 - x195 =L= 36.1127150166764;

e213..    x11 - x196 =L= 41.5760968853861;

e214..    x12 - x197 =L= 27.4485615783093;

e215..    x13 - x198 =L= 13.3650980650625;

e216..    x14 - x199 =L= 0.366844953624352;

e217..    x15 - x200 =L= -8.88297010968856;

e218..    x16 - x201 =L= -12.6153608127892;

e219..    x17 - x202 =L= -9.06134084359033;

e220..    x18 - x203 =L= 3.54807610999485;

e221..    x19 - x204 =L= 26.9818763600534;

e222..    x20 - x205 =L= 51.62316918069;

e223..    x21 - x206 =L= 75.9064200574462;

e224..    x22 - x207 =L= 49.5946235056795;

e225..    x23 - x208 =L= 22.2979679956446;

e226..    x24 - x209 =L= -4.99868751439049;

e227..    x25 - x210 =L= -32.2953430244255;

e228..    x26 - x211 =L= -59.5919985344606;
...
x1.l = -51.9671022516769; 
x2.l = -31.8616372680017; 
x3.l = -11.7561722843265; 
x4.l = 8.34929269934863; 
x5.l = 28.4547576830238; 
x6.l = 47.8926413650383; 
x7.l = 40.1589689814284; 
x8.l = 32.6149199066612; 
x9.l = 30.9929455834451; 
x10.l = 36.1127150166764; 
x11.l = 41.5760968853861; 
x12.l = 27.4485615783093; 
x13.l = 13.3650980650625; 
x14.l = 0.366844953624352; 
x15.l = -8.88297010968856; 
x16.l = -12.6153608127892; 
x17.l = -9.06134084359033; 
x18.l = 3.54807610999485; 
x19.l = 26.9818763600534; 
x20.l = 51.62316918069; 
x21.l = 75.9064200574462; 
x22.l = 49.5946235056795; 
x23.l = 22.2979679956446; 
x24.l = -4.99868751439049; 
x25.l = -32.2953430244255; 
x26.l = -59.5919985344606; 
x27.l = 1; 
x28.l = 1; 
x29.l = 1; 
x30.l = 1; 
