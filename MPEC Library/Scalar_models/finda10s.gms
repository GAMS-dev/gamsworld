*  MPEC written by GAMS Convert at 11/14/01 10:42:11
*  
*  Equation counts
*     Total       E       G       L       N       X
*       229      77     126      26       0       0
...
Positive Variables x77,x78,x79,x80,x81,x82,x83,x84,x85,x86,x87,x88,x89,x90,x91
          ...
          ,x172,x173,x174,x175,x176,x178,x180,x181,x182,x183,x184,x186,x187
...
e6..  - 0.03125*x30 + 0.0625*x31 - 0.03125*x32 + x56 =E= 6.39;
...
e11..  - 0.03125*x35 + 0.0625*x36 - 0.03125*x37 + x61 =E= 6.39;
...
e21..  - 0.03125*x45 + 0.0625*x46 - 0.03125*x47 + x71 =E= 8.52;
...
e177..    x1 + x186 =G= -1.44565750975879;

e178..    x2 + x187 =G= -0.846780049749712;

e179..    x3 + x188 =G= -0.247902589740634;

e180..    x4 + x189 =G= 0.350974870268445;

e181..    x5 + x190 =G= 0.949852330277524;

e182..    x6 + x191 =G= 1.38108045283826;

e183..    x7 + x192 =G= 1.02329618099015;

e184..    x8 + x193 =G= 0.676485864770745;

e185..    x9 + x194 =G= 0.662438318983198;

e186..    x10 + x195 =G= 0.979806952937821;

e187..    x11 + x196 =G= 1.31081982847496;

e188..    x12 + x197 =G= 0.869682934054966;

e189..    x13 + x198 =G= 0.293549818779954;

e190..    x14 + x199 =G= -0.195845361587797;

e191..    x15 + x200 =G= -0.516987700000027;

e192..    x16 + x201 =G= -0.588362289408469;

e193..    x17 + x202 =G= -0.328454222764845;

e194..    x18 + x203 =G= 0.344251406979092;

e195..    x19 + x204 =G= 1.51126950687161;

e196..    x20 + x205 =G= 3.08967722734447;

e197..    x21 + x206 =G= 4.5072547042514;

e198..    x22 + x207 =G= 2.82520348500864;

e199..    x23 + x208 =G= 0.773619341720658;

e200..    x24 + x209 =G= -1.27796480156733;

e201..    x25 + x210 =G= -3.32954894485531;

e202..    x26 + x211 =G= -5.3811330881433;

e203..    x1 - x186 =L= -1.44565750975879;

e204..    x2 - x187 =L= -0.846780049749712;

e205..    x3 - x188 =L= -0.247902589740634;

e206..    x4 - x189 =L= 0.350974870268445;

e207..    x5 - x190 =L= 0.949852330277524;

e208..    x6 - x191 =L= 1.38108045283826;

e209..    x7 - x192 =L= 1.02329618099015;

e210..    x8 - x193 =L= 0.676485864770745;

e211..    x9 - x194 =L= 0.662438318983198;

e212..    x10 - x195 =L= 0.979806952937821;

e213..    x11 - x196 =L= 1.31081982847496;

e214..    x12 - x197 =L= 0.869682934054966;

e215..    x13 - x198 =L= 0.293549818779954;

e216..    x14 - x199 =L= -0.195845361587797;

e217..    x15 - x200 =L= -0.516987700000027;

e218..    x16 - x201 =L= -0.588362289408469;

e219..    x17 - x202 =L= -0.328454222764845;

e220..    x18 - x203 =L= 0.344251406979092;

e221..    x19 - x204 =L= 1.51126950687161;

e222..    x20 - x205 =L= 3.08967722734447;

e223..    x21 - x206 =L= 4.5072547042514;

e224..    x22 - x207 =L= 2.82520348500864;

e225..    x23 - x208 =L= 0.773619341720658;

e226..    x24 - x209 =L= -1.27796480156733;

e227..    x25 - x210 =L= -3.32954894485531;

e228..    x26 - x211 =L= -5.3811330881433;
...
x177.lo = 30; x177.up = 300; 
x178.up = 5; 
x179.lo = 30; x179.up = 300; 
x180.fx = 0; 
x181.up = 300; 
x182.up = 5; 
x183.up = 300; 
...
x1.l = -1.44565750975879; 
x2.l = -0.846780049749712; 
x3.l = -0.247902589740634; 
x4.l = 0.350974870268445; 
x5.l = 0.949852330277524; 
x6.l = 1.38108045283826; 
x7.l = 1.02329618099015; 
x8.l = 0.676485864770745; 
x9.l = 0.662438318983198; 
x10.l = 0.979806952937821; 
x11.l = 1.31081982847496; 
x12.l = 0.869682934054966; 
x13.l = 0.293549818779954; 
x14.l = -0.195845361587797; 
x15.l = -0.516987700000027; 
x16.l = -0.588362289408469; 
x17.l = -0.328454222764845; 
x18.l = 0.344251406979092; 
x19.l = 1.51126950687161; 
x20.l = 3.08967722734447; 
x21.l = 4.5072547042514; 
x22.l = 2.82520348500864; 
x23.l = 0.773619341720658; 
x24.l = -1.27796480156733; 
x25.l = -3.32954894485531; 
x26.l = -5.3811330881433; 
x27.l = 1; 
x28.l = 1; 
x29.l = 1; 
x30.l = 1; 
