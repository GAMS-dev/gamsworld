*  MPEC written by GAMS Convert at 11/14/01 10:42:28
*  
*  Equation counts
*     Total       E       G       L       N       X
*       203      77     113      13       0       0
...
e178..    x3 + x187 =G= -11.1963545565015;

e179..    x5 + x188 =G= 27.0997692219274;

e180..    x7 + x189 =G= 38.2466371251699;

e181..    x9 + x190 =G= 29.5170910318524;

e182..    x11 + x191 =G= 39.5962827479868;

e183..    x13 + x192 =G= 12.728664823869;

e184..    x15 + x193 =G= -8.45997153303673;

e185..    x17 + x194 =G= -8.62984842246698;

e186..    x19 + x195 =G= 25.6970251048127;

e187..    x21 + x196 =G= 72.2918286261392;

e188..    x23 + x197 =G= 21.236159995852;

e189..    x25 + x198 =G= -30.757469547072;

e190..    x1 - x186 =L= -49.4924783349304;

e191..    x3 - x187 =L= -11.1963545565015;

e192..    x5 - x188 =L= 27.0997692219274;

e193..    x7 - x189 =L= 38.2466371251699;

e194..    x9 - x190 =L= 29.5170910318524;

e195..    x11 - x191 =L= 39.5962827479868;

e196..    x13 - x192 =L= 12.728664823869;

e197..    x15 - x193 =L= -8.45997153303673;

e198..    x17 - x194 =L= -8.62984842246698;

e199..    x19 - x195 =L= 25.6970251048127;

e200..    x21 - x196 =L= 72.2918286261392;

e201..    x23 - x197 =L= 21.236159995852;

e202..    x25 - x198 =L= -30.757469547072;
