*  MPEC written by GAMS Convert at 11/14/01 10:42:23
*  
*  Equation counts
*     Total       E       G       L       N       X
*       203      77     113      13       0       0
...
e178..    x3 + x187 =G= -0.247902589740634;

e179..    x5 + x188 =G= 0.949852330277524;

e180..    x7 + x189 =G= 1.02329618099015;

e181..    x9 + x190 =G= 0.662438318983198;

e182..    x11 + x191 =G= 1.31081982847496;

e183..    x13 + x192 =G= 0.293549818779954;

e184..    x15 + x193 =G= -0.516987700000027;

e185..    x17 + x194 =G= -0.328454222764845;

e186..    x19 + x195 =G= 1.51126950687161;

e187..    x21 + x196 =G= 4.5072547042514;

e188..    x23 + x197 =G= 0.773619341720658;

e189..    x25 + x198 =G= -3.32954894485531;

e190..    x1 - x186 =L= -1.44565750975879;

e191..    x3 - x187 =L= -0.247902589740634;

e192..    x5 - x188 =L= 0.949852330277524;

e193..    x7 - x189 =L= 1.02329618099015;

e194..    x9 - x190 =L= 0.662438318983198;

e195..    x11 - x191 =L= 1.31081982847496;

e196..    x13 - x192 =L= 0.293549818779954;

e197..    x15 - x193 =L= -0.516987700000027;

e198..    x17 - x194 =L= -0.328454222764845;

e199..    x19 - x195 =L= 1.51126950687161;

e200..    x21 - x196 =L= 4.5072547042514;

e201..    x23 - x197 =L= 0.773619341720658;

e202..    x25 - x198 =L= -3.32954894485531;

e203..    objvar - x186 - x187 - x188 - x189 - x190 - x191 - x192 - x193 - x194
        - x195 - x196 - x197 - x198 =E= 0;
