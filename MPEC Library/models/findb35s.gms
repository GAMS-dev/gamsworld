*  MPEC written by GAMS Convert at 11/14/01 10:42:31
*  
*  Equation counts
*     Total       E       G       L       N       X
*       203      77     113      13       0       0
...
e178..    x3 + x187 =G= -11.7561722843265;

e179..    x5 + x188 =G= 28.4547576830238;

e180..    x7 + x189 =G= 40.1589689814284;

e181..    x9 + x190 =G= 30.9929455834451;

e182..    x11 + x191 =G= 41.5760968853861;

e183..    x13 + x192 =G= 13.3650980650625;

e184..    x15 + x193 =G= -8.88297010968856;

e185..    x17 + x194 =G= -9.06134084359033;

e186..    x19 + x195 =G= 26.9818763600534;

e187..    x21 + x196 =G= 75.9064200574462;

e188..    x23 + x197 =G= 22.2979679956446;

e189..    x25 + x198 =G= -32.2953430244255;

e190..    x1 - x186 =L= -51.9671022516769;

e191..    x3 - x187 =L= -11.7561722843265;

e192..    x5 - x188 =L= 28.4547576830238;

e193..    x7 - x189 =L= 40.1589689814284;

e194..    x9 - x190 =L= 30.9929455834451;

e195..    x11 - x191 =L= 41.5760968853861;

e196..    x13 - x192 =L= 13.3650980650625;

e197..    x15 - x193 =L= -8.88297010968856;

e198..    x17 - x194 =L= -9.06134084359033;

e199..    x19 - x195 =L= 26.9818763600534;

e200..    x21 - x196 =L= 75.9064200574462;

e201..    x23 - x197 =L= 22.2979679956446;

e202..    x25 - x198 =L= -32.2953430244255;
