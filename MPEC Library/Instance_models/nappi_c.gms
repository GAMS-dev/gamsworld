...
e13..  - x4 - 0.707106781186547*x9 - 0.707106781186547*x10 =E= -500;
...
e42..    x12 + x109 =G= 0.303509168702781;

e43..    x13 + x110 =G= -2.43897272461382;

e44..    x14 + x111 =G= -1.19258821646486;

e45..    x15 + x112 =G= -3.57004975532878;

e46..    x16 + x113 =G= -1.27370385078767;

e47..    x17 + x114 =G= -2.09711121955391;

e48..    x18 + x115 =G= -1.4062822669605;

e49..    x19 + x116 =G= -0.132578416172825;

e50..    x12 - x109 =L= 0.303509168702781;

e51..    x13 - x110 =L= -2.43897272461382;

e52..    x14 - x111 =L= -1.19258821646486;

e53..    x15 - x112 =L= -3.57004975532878;

e54..    x16 - x113 =L= -1.27370385078767;

e55..    x17 - x114 =L= -2.09711121955391;

e56..    x18 - x115 =L= -1.4062822669605;

e57..    x19 - x116 =L= -0.132578416172825;
...
x10.l = 1; 
x11.l = 1; 
x12.l = 0.303509168702781; 
x13.l = -2.43897272461382; 
x14.l = -1.19258821646486; 
x15.l = -3.57004975532878; 
x16.l = -1.27370385078767; 
x17.l = -2.09711121955391; 
x18.l = -1.4062822669605; 
x19.l = -0.132578416172825; 
x42.l = 10; 
x45.l = 10; 
x46.l = 10; 
x49.l = 10; 
