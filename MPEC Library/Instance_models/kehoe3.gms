*  MPEC written by GAMS Convert at 06/06/02 11:17:17
*  
*  Equation counts
*     Total       E       G       L       N       X       C
*        11       5       6       0       0       0       0
...
e1.. sqr(x3 - 1) + sqr(x4 - 1) + sqr(x5 - 1) + sqr(x6 - 1) + objvar =E= 0;

e2..  - 6*x3 + x4 + 4*x5 + x6 =G= 0;

e3..    x3 - 3*x4 + x5 + x6 =G= 0;

e4..  - (0.52*x7/x3 + 0.86*x8/x3 + 0.5*x9/x3 + 0.06*x10/x3) + 6*x1 - x2 =N= -5;
