*  MPEC written by GAMS Convert at 01/04/02 11:31:20
*  
*  Equation counts
*     Total       E       G       L       N       X
*        98      60      30       8       0       0
...
e17..    x4 + 0.707106781186547*x8 + 0.707106781186547*x11 =E= -550;
...
e42..    x12 + x109 =G= 0.301137754266277;

e43..    x13 + x110 =G= -11.1121199924568;

e44..    x14 + x111 =G= -0.891997538037562;

e45..    x15 + x112 =G= -5.58531205735265;

e46..    x16 + x113 =G= -1.15631883618073;

e47..    x17 + x114 =G= -11.0208158750534;

e48..    x18 + x115 =G= -1.4673600873009;

e49..    x19 + x116 =G= -0.311041251120169;

e50..    x12 - x109 =L= 0.301137754266277;

e51..    x13 - x110 =L= -11.1121199924568;

e52..    x14 - x111 =L= -0.891997538037562;

e53..    x15 - x112 =L= -5.58531205735265;

e54..    x16 - x113 =L= -1.15631883618073;

e55..    x17 - x114 =L= -11.0208158750534;

e56..    x18 - x115 =L= -1.4673600873009;

e57..    x19 - x116 =L= -0.311041251120169;
...
x10.l = 1; 
x11.l = 1; 
x12.l = 0.301137754266277; 
x13.l = -11.1121199924568; 
x14.l = -0.891997538037562; 
x15.l = -5.58531205735265; 
x16.l = -1.15631883618073; 
x17.l = -11.0208158750534; 
x18.l = -1.4673600873009; 
x19.l = -0.311041251120169; 
x42.l = 10; 
x45.l = 10; 
x46.l = 10; 
x49.l = 10; 
