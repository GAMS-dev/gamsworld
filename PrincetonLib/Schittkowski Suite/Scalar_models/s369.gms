...
e2..    0.01*x5 - 0.01*x8 =G= -1;

e3..    0.0025*x4 - 0.0025*x5 - 0.0025*x7 =G= -1;

e4.. (-833.33252*x4/(x1*x6)) - 100/x6 + 83333.333/(x1*x6) =G= -1;

e5.. (-1250*x5/(x2*x7)) - x4/x7 + 1250*x4/(x2*x7) =G= -1;

e6.. (-1250000/(x3*x8)) - x5/x8 + 2500*x5/(x3*x8) =G= -1;
