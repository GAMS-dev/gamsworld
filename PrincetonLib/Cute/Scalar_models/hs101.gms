...
e5.. 10*sqr(x4)*x1*exp(-0.25*log(x7))/(POWER(x6,3)*x2) + 15*x3*x4/(sqr(x2)*x1*
     x5*sqrt(x7)) + 20*x2*x6/(sqr(x1)*x4*sqr(x5)) + 25*sqr(x1)*sqr(x2)*sqrt(x5)
     *x7/(sqr(x6)*x3) =G= 100;

e6.. 10*sqr(x4)*x1*exp(-0.25*log(x7))/(POWER(x6,3)*x2) + 15*x3*x4/(sqr(x2)*x1*
     x5*sqrt(x7)) + 20*x2*x6/(sqr(x1)*x4*sqr(x5)) + 25*sqr(x1)*sqr(x2)*sqrt(x5)
     *x7/(sqr(x6)*x3) =L= 3000;

e7..  - (10*sqr(x4)*x1*exp(-0.25*log(x7))/(POWER(x6,3)*x2) + 15*x3*x4/(sqr(x2)*
