*  DNLP written by GAMS Convert at 10/06/06 11:34:13
*  
*  Equation counts
*      Total        E        G        L        N        X        C
*         12       12        0        0        0        0        0
...
e2.. abs(x3)*x3 - abs(x4)*x4 - 0.597053452*exp(0.8539*log(abs(x9)))*x9 =E= 0;

e3.. abs(x4)*x4 - abs(x5)*x5 - 0.597053452*exp(0.8539*log(abs(x10)))*x10 =E= 0;

e4.. abs(x6)*x6 - abs(x7)*x7 - 0.597053452*exp(0.8539*log(abs(x11)))*x11 =E= 0;
