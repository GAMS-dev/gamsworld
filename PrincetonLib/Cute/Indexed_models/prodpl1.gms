...
smooth1.. 0 =g= sqr((x00302+x00402)-x00301+x00401) - 0.1 * sqr(x00301+x00401) ;
smooth2.. 0 =g= sqr((x00303+x00403)-x00302+x00402) - 0.1 * sqr(x00302+x00402) ;
smooth3.. 0 =g= sqr((x00304+x00404)-x00303+x00403) - 0.1 * sqr(x00303+x00403) ;
smooth4.. 0 =g= sqr((x00305+x00405)-x00304+x00404) - 0.1 * sqr(x00304+x00404) ;
...
Solve prodpl1 using nlp minimazing obj ;

 display x00101.l ; display x00201.l ; display x00301.l ;
 display x00401.l ; display x00102.l ; display x00202.l ;
 display x00302.l ; display x00402.l ; display x00103.l ;
 display x00203.l ; display x00303.l ; display x00403.l ;
 display x00104.l ; display x00204.l ; display x00304.l ;
 display x00404.l ; display x00105.l ; display x00205.l ;
 display x00305.l ; display x00405.l ; display i00101.l ;
 display y00101.l ; display i00201.l ; display y00201.l ;
 display i00301.l ; display y00301.l ; display i00401.l ;
 display y00401.l ; display i00102.l ; display y00102.l ;
 display i00202.l ; display y00202.l ; display i00302.l ;
 display y00302.l ; display i00402.l ; display y00402.l ;
 display i00103.l ; display y00103.l ; display i00203.l ;
 display y00203.l ; display i00303.l ; display y00303.l ;
 display i00403.l ; display y00403.l ; display i00104.l ;
 display y00104.l ; display i00204.l ; display y00204.l ;
 display i00304.l ; display y00304.l ; display i00404.l ;
 display y00404.l ; display i00105.l ; display y00105.l ;
 display i00205.l ; display y00205.l ; display i00305.l ;
 display y00305.l ; display i00405.l ; display y00405.l ;
 display obj.l ;
