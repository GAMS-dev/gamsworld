...
Def_obj..
  obj =e= (a + b + 0.69)*(a + b + 0.69) + (c + d + 0.044)*(c + d + 0.044) +
          (t * a + u * b - v * c - w * d + 1.57) *
          (t * a + u * b - v * c - w * d + 1.57) +
          (v * a + w * b + t * c + u * d + 1.31) *
          (v * a + w * b + t * c + u * d + 1.31) +
          (a * (t*t-v*v) - 2.0*c * t * v + b * (u*u-w*w) -
           2.0*d * u * w + 2.65) *
          (a * (t*t-v*v) - 2.0*c * t * v + b * (u*u-w*w) -
           2.0*d * u * w + 2.65) +
          (c * (t*t-v*v) + 2.0*a * t * v + d * (u*u-w*w) +
           2.0*b * u * w - 2.0)*(c * (t*t-v*v) +
           2.0*a * t * v + d * (u*u-w*w) + 2.0*b * u * w - 2.0) +
          (a * t * (t*t-(3.0)*v*v) + c * v * (v*v-(3.0)*t*t) + b * u *
           (u*u-(3.0)*w*w) + d * w * (w*w-(3.0)*u*u) + 12.6)*
          (a * t * (t*t-(3.0)*v*v) + c * v * (v*v-(3.0)*t*t) + b * u *
           (u*u-(3.0)*w*w) + d * w * (w*w-(3.0)*u*u) + 12.6) +
          (c * t * (t*t-(3.0)*v*v) - a * v * (v*v-(3.0)*t*t) + d * u *
           (u*u-(3.0)*w*w) - b * w * (w*w-(3.0)*u*u) - 9.48)*
          (c * t * (t*t-(3.0)*v*v) - a * v * (v*v-(3.0)*t*t) + d * u *
           (u*u-(3.0)*w*w) - b * w * (w*w-(3.0)*u*u) - 9.48) ;
...
Model heart8ls /all/;
Solve heart8ls using nlp minimize obj;
