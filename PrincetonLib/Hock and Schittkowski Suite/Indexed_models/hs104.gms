...
c1.. 1-.0588*x['i5']*x['i7']-0.1*x['i1']=g=0;
c2.. 1-.0588*x['i6']*x['i8']-.1*x['i1']-0.1*x['i2']=g=0;
c3.. 1 - 4*x['i3']/x['i5']-
          2/(exp(log(x['i3'])*(0.71))*x['i5'])-
          0.0588*x['i7']/exp(log(x['i3'])*(1.3)) =g= 0 ;
c4.. 1-4*x['i4']/x['i6']-
        2/(exp(log(x['i4'])*(0.71))*x['i6'])-
        0.0588*x['i8']/exp(log(x['i4'])*(1.3)) =g= 0 ;
...
Model hs104 /all/ ;
Solve hs104 using nlp minimazing obj ;
