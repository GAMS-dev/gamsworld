...
c1.. 1-0.5*sqrt(x['i1'])*x['i7']/(x['i3']*sqr(x['i6']))-
      ...
      -0.2*x['i3']*exp(log(x['i6'])*(2/3))*sqrt(sqrt(x['i7']))/
       (x['i2']*sqrt(x['i4'])) =g= 0;
...
c3.. 1-2.0*x['i1']*x['i5']*exp(log(x['i7'])*(1/3))/(exp(log(x['i3'])*1.5)*x['i6'])-
       0.1*x['i2']*x['i5']/(sqrt(x['i3'])*x['i6']*sqrt(x['i7']))-
           x['i2']*sqrt(x['i3'])*x['i5']/x['i1']-
       0.65*x['i3']*x['i5']*x['i7']/(sqr(x['i2'])*x['i6']) =g= 0;

c4.. 1-0.2*x['i2']*sqrt(x['i5'])*exp(log(x['i7'])*(1/3))/(sqr(x['i1'])*x['i4'])-
       0.3*sqrt(x['i1'])*sqr(x['i2'])*x['i3']*exp(log(x['i4'])*(1/3))*
       sqrt(sqrt(x['i7']))/
       exp(log(x['i5'])*(2/3))-
       0.4*x['i3']*x['i5']*exp(log(x['i7'])*0.75)/(power(x['i1'],3)*sqr(x['i2']))
      -0.5*x['i4']*sqrt(x['i7'])/sqr(x['i3']) =g= 0;

c5.. 10*x['i1']*sqr(x['i4'])*exp(log(x['i7'])*a)/
...
Solve hs101 using nlp minimazing obj ;

obj.l = obj.l - 1809.76476;
display obj.l;
