...
/bin/rm -rf ${TMPLIB}
mkdir ${TMPLIB} || exit 2
FILES="fr_genct.gms frictionalblock.gms"
FILES="$FILES fr_block1.dat"
FILES="$FILES fr_block2.dat"
FILES="$FILES fr_block3.dat"
FILES="$FILES fr_block4.dat"
FILES="$FILES fr_block5.dat"
FILES="$FILES fr_block6.dat"
for i in ${FILES} ; do
...
gamscmd="gams frictionalblock.gms mcp=pathc mpec=convert optfile=1"

for cas in 1 2 3 4 5 6 ; do
    userx="--case=$cas"
    gmsname="frictionalblock_${cas}.gms"
    echo $gamscmd $userx
    $gamscmd $userx
